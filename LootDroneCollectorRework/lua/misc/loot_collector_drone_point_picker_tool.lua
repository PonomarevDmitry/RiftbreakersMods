...
class 'loot_collector_drone_point_picker_tool' ( tool )

function loot_collector_drone_point_picker_tool:__init()
    tool.__init(self,self)
end

function loot_collector_drone_point_picker_tool:OnInit()
...
function loot_collector_drone_point_picker_tool:GetBuildingDisplayRadius( blueprintDatabase )
...
function loot_collector_drone_point_picker_tool:OnPreInit()
    self.initialScale = { x=1, y=1, z=1 }
end

function loot_collector_drone_point_picker_tool:GetScaleFromDatabase()
    return { x=1, y=1, z=1 }
end

function loot_collector_drone_point_picker_tool:SpawnCornerBlueprint()
    if ( self.corners == nil ) then
        self.corners = EntityService:SpawnAndAttachEntity("misc/marker_selector_corner_tool", self.entity )
    end
end

function loot_collector_drone_point_picker_tool:AddedToSelection( entity )
end

function loot_collector_drone_point_picker_tool:RemovedFromSelection( entity )
...
function loot_collector_drone_point_picker_tool:OnUpdate()
...
function loot_collector_drone_point_picker_tool:SetEntitySelectedMaterial( entity, material )
...
function loot_collector_drone_point_picker_tool:FindEntitiesToSelect( selectorComponent )
...
function loot_collector_drone_point_picker_tool:FindTowerDronePointsParents(position)
...
function loot_collector_drone_point_picker_tool:FilterSelectedEntities( selectedEntities )
...
function loot_collector_drone_point_picker_tool:ShowBuildingDisplayRadiusWithoutGroup()
...
function loot_collector_drone_point_picker_tool:FindBuildingLowUpgrade()
...
function loot_collector_drone_point_picker_tool:OnActivateSelectorRequest()
...
function loot_collector_drone_point_picker_tool:OnActivateEntity( entity, removalEnabled, ignoreDisplayingRadiusComponent )
...
function loot_collector_drone_point_picker_tool:ShowDisplayRadiusComponent()
...
function loot_collector_drone_point_picker_tool:OnRotateSelectorRequest(evt)
...
function loot_collector_drone_point_picker_tool:ClearPickedBuildings()
...
function loot_collector_drone_point_picker_tool:OnRelease()
...
return loot_collector_drone_point_picker_tool
