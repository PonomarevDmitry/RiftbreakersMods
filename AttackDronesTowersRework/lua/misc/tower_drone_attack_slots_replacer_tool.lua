...
class 'tower_drone_attack_slots_replacer_tool' ( tool )

function tower_drone_attack_slots_replacer_tool:__init()
    tool.__init(self,self)
end

function tower_drone_attack_slots_replacer_tool:OnInit()
...
function tower_drone_attack_slots_replacer_tool:OnPreInit()
    self.initialScale = { x=8, y=1, z=8 }
end

function tower_drone_attack_slots_replacer_tool:GetSlotsArrayFromString(currentValue)
...
function tower_drone_attack_slots_replacer_tool:UpdateMarker()
...
function tower_drone_attack_slots_replacer_tool:SetSlotsIcons(slotsArray, markerDB)
...
function tower_drone_attack_slots_replacer_tool:SpawnCornerBlueprint()
    if ( self.corners == nil ) then
        self.corners = EntityService:SpawnAndAttachEntity("misc/marker_selector_corner_tool", self.entity )
    end
end

function tower_drone_attack_slots_replacer_tool:AddedToSelection( entity )
...
function tower_drone_attack_slots_replacer_tool:RemovedFromSelection( entity )
    EntityService:RemoveMaterial(entity, "selected" )
end

function tower_drone_attack_slots_replacer_tool:FilterSelectedEntities( selectedEntities )
...
function tower_drone_attack_slots_replacer_tool:GetSlotsValues(equipmentComponent, entity)
...
function tower_drone_attack_slots_replacer_tool:IsEqualSlots(slots1, slots2)
...
function tower_drone_attack_slots_replacer_tool:OnActivateEntity( entity )
...
return tower_drone_attack_slots_replacer_tool
