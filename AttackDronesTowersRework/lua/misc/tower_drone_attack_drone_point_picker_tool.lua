...
function tower_drone_attack_drone_point_picker_tool:SetEntitySelectedMaterial( entity, material )
...
function tower_drone_attack_drone_point_picker_tool:FindEntitiesToSelect( selectorComponent )
...
function tower_drone_attack_drone_point_picker_tool:FindTowerDronePointsParents(position)
...
function tower_drone_attack_drone_point_picker_tool:ShowBuildingDisplayRadiusWithoutGroup()
...
function tower_drone_attack_drone_point_picker_tool:FindBuildingLowUpgrade()
...
function tower_drone_attack_drone_point_picker_tool:OnActivateEntity( entity, removalEnabled, ignoreDisplayingRadiusComponent )
...
function tower_drone_attack_drone_point_picker_tool:ShowDisplayRadiusComponent()
...
function tower_drone_attack_drone_point_picker_tool:CreateDisplayRadiusComponent(min, max)
