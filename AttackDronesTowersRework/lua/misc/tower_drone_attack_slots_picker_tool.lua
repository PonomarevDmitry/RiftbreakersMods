...
class 'tower_drone_attack_slots_picker_tool' ( tool )

function tower_drone_attack_slots_picker_tool:__init()
    tool.__init(self,self)
end

function tower_drone_attack_slots_picker_tool:OnInit()
...
function tower_drone_attack_slots_picker_tool:GetSlotsArrayFromString(currentValue)
...
function tower_drone_attack_slots_picker_tool:UpdateMarker()
...
function tower_drone_attack_slots_picker_tool:SetSlotsIcons(slotsArray, markerDB)
...
function tower_drone_attack_slots_picker_tool:OnPreInit()
    self.initialScale = { x=1, y=1, z=1 }
end

function tower_drone_attack_slots_picker_tool:GetScaleFromDatabase()
    return { x=1, y=1, z=1 }
end

function tower_drone_attack_slots_picker_tool:SpawnCornerBlueprint()
    if ( self.corners == nil ) then
        self.corners = EntityService:SpawnAndAttachEntity("misc/marker_selector_corner_tool", self.entity )
    end
end

function tower_drone_attack_slots_picker_tool:AddedToSelection( entity )
...
function tower_drone_attack_slots_picker_tool:RemovedFromSelection( entity )
...
function tower_drone_attack_slots_picker_tool:FilterSelectedEntities( selectedEntities )
...
function tower_drone_attack_slots_picker_tool:GetSlotsValues(equipmentComponent, entity)
    ...
    for i=1,3 do
        ...
        if ( slot ) then
            ...
            blueprintName = self.defaultModBlueprintName
...
function tower_drone_attack_slots_picker_tool:IsEqualSlots(slots1, slots2)
...
function tower_drone_attack_slots_picker_tool:IsFullEqualSlots(slots1, slots2)
...
function tower_drone_attack_slots_picker_tool:OnActivateSelectorRequest()
...
function tower_drone_attack_slots_picker_tool:ChangeSelector(slotsValues)
...
function tower_drone_attack_slots_picker_tool:FillLastSlotssList(defaultModesArray, modeSelectLast, selector)
...
function tower_drone_attack_slots_picker_tool:GetSlotsIndexOf( array, slots )
...
function tower_drone_attack_slots_picker_tool:GetCurrentList(parameterName, selectorDB)
...
function tower_drone_attack_slots_picker_tool:GetCurrentListString(parameterName, selectorDB)
...
function tower_drone_attack_slots_picker_tool:AddSlotsToLastList(slots, selectorDB)
...
function tower_drone_attack_slots_picker_tool:OnRotateSelectorRequest(evt)
...
function tower_drone_attack_slots_picker_tool:CheckModeValueExists( selectedMode )
...
return tower_drone_attack_slots_picker_tool
