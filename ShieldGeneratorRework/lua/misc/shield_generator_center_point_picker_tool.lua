...
class 'shield_generator_center_point_picker_tool' ( tool )

function shield_generator_center_point_picker_tool:__init()
    tool.__init(self,self)
end

function shield_generator_center_point_picker_tool:OnInit()
...
function shield_generator_center_point_picker_tool:GetBuildingDisplayRadius( blueprintDatabase )
...
function shield_generator_center_point_picker_tool:OnPreInit()
    self.initialScale = { x=1, y=1, z=1 }
end

function shield_generator_center_point_picker_tool:GetScaleFromDatabase()
    return { x=1, y=1, z=1 }
end

function shield_generator_center_point_picker_tool:SpawnCornerBlueprint()
    if ( self.corners == nil ) then
        self.corners = EntityService:SpawnAndAttachEntity("misc/marker_selector_corner_tool", self.entity )
    end
end

function shield_generator_center_point_picker_tool:AddedToSelection( entity )
end

function shield_generator_center_point_picker_tool:RemovedFromSelection( entity )
...
function shield_generator_center_point_picker_tool:OnUpdate()
...
function shield_generator_center_point_picker_tool:SetEntitySelectedMaterial( entity, material )
...
function shield_generator_center_point_picker_tool:FindEntitiesToSelect( selectorComponent )
...
function shield_generator_center_point_picker_tool:FindTowerDronePointsParents(position)
...
function shield_generator_center_point_picker_tool:FilterSelectedEntities( selectedEntities )
...
function shield_generator_center_point_picker_tool:ShowBuildingDisplayRadiusWithoutGroup()
...
function shield_generator_center_point_picker_tool:FindBuildingLowUpgrade()
...
function shield_generator_center_point_picker_tool:OnActivateSelectorRequest()
...
function shield_generator_center_point_picker_tool:OnActivateEntity( entity, removalEnabled, ignoreDisplayingRadiusComponent )
...
function shield_generator_center_point_picker_tool:ShowDisplayRadiusComponent()
...
function shield_generator_center_point_picker_tool:CreateDisplayRadiusComponent(min, max)
...
function shield_generator_center_point_picker_tool:OnRotateSelectorRequest(evt)
...
function shield_generator_center_point_picker_tool:ClearPickedBuildings()
...
function shield_generator_center_point_picker_tool:OnRelease()
...
return shield_generator_center_point_picker_tool
