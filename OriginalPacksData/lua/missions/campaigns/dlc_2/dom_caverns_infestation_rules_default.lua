return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_falling_stalactites", type = "POSITIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/falling_stalactites.logic" },
		{ action = "spawn_falling_stalactites", type = "POSITIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/falling_stalactites.logic" },
	}
