...
class 'mission_caverns_infestation' ( mission_base )

function mission_caverns_infestation:__init()
    mission_base.__init(self,self)
end

--function mission_caverns_infestation:UpdateMissionProgress()
...
--function mission_caverns_infestation:OnLoad()
...
function mission_caverns_infestation:init()
    ...
    MissionService:ActivateMissionFlow("", "logic/missions/campaigns/dlc_2/caverns_infestation.logic", "default" )

    local rulesPath = GetRulesForDifficulty( "lua/missions/campaigns/dlc_2/dom_caverns_infestation_rules_" )
    MissionService:AddGameRule( "lua/missions/v2/dom_manager.lua", rulesPath )
end

return mission_caverns_infestation