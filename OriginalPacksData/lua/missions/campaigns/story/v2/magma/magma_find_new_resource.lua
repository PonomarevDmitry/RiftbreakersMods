...
class 'mission_magma_find_new_resource' ( mission_base )

function mission_magma_find_new_resource:__init()
...
function mission_magma_find_new_resource:init()
    ...
    local rulesPath = GetRulesForDifficulty( "lua/missions/campaigns/story/v2/magma/dom_magma_find_new_resource_rules_" )
    MissionService:AddGameRule( "lua/missions/v2/dom_manager.lua", rulesPath )
end

return mission_magma_find_new_resource