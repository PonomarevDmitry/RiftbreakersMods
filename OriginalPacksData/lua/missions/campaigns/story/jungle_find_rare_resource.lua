...
class 'mission_jungle_find_rare_resource' ( mission_base )

function mission_jungle_find_rare_resource:__init()
...
function mission_jungle_find_rare_resource:init()
    ...
    local rulesPath = GetRulesForDifficulty( "lua/missions/campaigns/story/v2/jungle/dom_jungle_find_rare_resource_rules_" )
    MissionService:AddGameRule( "lua/missions/v2/dom_manager.lua", rulesPath )
end

return mission_jungle_find_rare_resource