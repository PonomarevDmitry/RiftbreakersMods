return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_ion_storm", type = "POSITIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, logicFile="logic/weather/ion_storm.logic", minTime = 30, maxTime = 60, weight = 4 },
		{ action = "spawn_ion_storm", type = "POSITIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/ion_storm.logic", minTime = 30, maxTime = 60, weight = 4 },		
