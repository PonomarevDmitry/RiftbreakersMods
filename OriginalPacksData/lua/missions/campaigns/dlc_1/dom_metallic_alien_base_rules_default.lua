return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_thunderstorm", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, logicFile="logic/weather/thunderstorm.logic", minTime = 60, maxTime = 120, weight = 2 },
		{ action = "spawn_thunderstorm", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/thunderstorm.logic", minTime = 60, maxTime = 120, weight = 2 },
		...
		{ action = "spawn_ion_storm", type = "POSITIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 2, logicFile="logic/weather/ion_storm.logic", minTime = 30, maxTime = 60, weight = 2 },
		{ action = "spawn_ion_storm", type = "POSITIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/ion_storm.logic", minTime = 30, maxTime = 60, weight = 2 },		
