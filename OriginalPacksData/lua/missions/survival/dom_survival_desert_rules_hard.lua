return function()
    local rules = require("lua/missions/survival/dom_survival_desert_rules_default.lua")()
	...
	--	{ name = "headquarters_lvl_3", logic = "logic/hq_upgrade/upgrade_lvl2_hard.logic" },   
	--	{ name = "headquarters_lvl_4", logic = "logic/hq_upgrade/upgrade_lvl3_hard.logic" },   
	--}
