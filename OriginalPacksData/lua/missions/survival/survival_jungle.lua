...
class 'survival_jungle' ( survival_base )

function survival_jungle:__init()
    survival_base.__init(self,self)
end

function survival_jungle:init()
	survival_base.init( self )
	LogService:Log( "survival_jungle:init()" )
