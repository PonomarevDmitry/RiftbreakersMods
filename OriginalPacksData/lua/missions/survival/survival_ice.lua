...
class 'survival_ice' ( survival_base )

function survival_ice:__init()
    survival_base.__init(self,self)
end

function survival_ice:init()
	survival_base.init(self)

	LogService:Log( "survival_ice:init()" )
    ...
    local rulesPath = GetRulesForDifficulty( "lua/missions/survival/v2/dom_survival_ice_rules_" )
