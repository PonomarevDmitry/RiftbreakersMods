return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_blizzard", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, logicFile="logic/weather/blizzard.logic", minTime = 60, maxTime = 120, weight = 1 },
		{ action = "spawn_blizzard", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/blizzard.logic", minTime = 60, maxTime = 120, weight = 1 },
		{ action = "spawn_heavy_snow", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, logicFile="logic/weather/heavy_snow.logic", minTime = 60, maxTime = 120, weight = 1 },
		{ action = "spawn_heavy_snow", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/heavy_snow.logic", minTime = 60, maxTime = 120, weight = 1 },		
		{ action = "spawn_tornado_ice_near_base", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/tornado_ice_near_base.logic", minTime = 30, maxTime = 60, weight = 1 },
