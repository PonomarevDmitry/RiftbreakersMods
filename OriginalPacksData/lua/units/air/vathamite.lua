...
class 'vathamite' ( LuaEntityObject )

function vathamite:__init()
	LuaEntityObject.__init(self, self)
end

function vathamite:init()
...
function vathamite:OnDestroyRequest( evt )
...
function vathamite:_OnIdleEnter( state )
	self.stateTimer = -math.random(0.0,10.0)
end
function vathamite:_OnIdleExecute( state, dt )
