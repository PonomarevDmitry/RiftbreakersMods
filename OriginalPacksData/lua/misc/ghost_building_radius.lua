...
function ghost_building_radius:__init()
    ghost.__init(self,self)
end

function ghost_building_radius:FindMinDistance()
...
function ghost_building_radius:OnUpdate()
...
function ghost_building_radius:OnActivate()
...
function ghost_building_radius:OnDeactivate()
    self.buildPosition = nil
end

function ghost_building_radius:OnRelease()
    HideBuildingDisplayRadiusAround( self.entity, self.blueprint )
end

return ghost_building_radius
