...
class 'fusion_field_accelerator' ( building )

function fusion_field_accelerator:__init()
...
function fusion_field_accelerator:OnBuildingStart()
	...
	EntityService:AttachEntity( self.entity, portal, "fusion_field_accelerator" )
	EntityService:SetName( self.entity, "fusion_field_accelerator")
	EntityService:SetPosition(self.entity, 0,0,0)
end
function fusion_field_accelerator:OnBuildingEnd()
	--BuildingService:DisableBuilding( self.entity )
