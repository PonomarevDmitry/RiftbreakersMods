class 'tower_portal_bomb' ( LuaEntityObject )

function tower_portal_bomb:__init()
	LuaEntityObject.__init(self,self)
end

function tower_portal_bomb:init()
...
function tower_portal_bomb:OnEnter( state )
...
function tower_portal_bomb:OnExecute( state, dt )
