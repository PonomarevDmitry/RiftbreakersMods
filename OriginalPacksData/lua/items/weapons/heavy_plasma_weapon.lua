...
class 'heavy_plasma_weapon' ( charge_weapon )

function heavy_plasma_weapon:__init()
...
function heavy_plasma_weapon:OnShieldEnter( state )

end

function heavy_plasma_weapon:OnShieldExecute( state, dt )
    if state:GetDuration() > 0.3 and not self.shieldCreated then 
        self:CreateShield()
    end
end

function heavy_plasma_weapon:OnShieldExit( state )
    self:RemoveShield()
end

function heavy_plasma_weapon:CreateShield()
...
function heavy_plasma_weapon:RemoveShield()
