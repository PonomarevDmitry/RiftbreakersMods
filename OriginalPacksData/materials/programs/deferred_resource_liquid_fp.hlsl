...
#   endif
    ...
    float3 albedo0 = lerp( albedo00.xyz, albedo01.xyz, blendPower );
    ...
    float3 albedo1 = lerp( albedo10.xyz, albedo11.xyz, blendPower );
    ...
    float3 normal0 = lerp( texNormal00, texNormal01, blendPower );
    ...
    float3 normal1 = lerp( texNormal10, texNormal11, blendPower );
    ...
    float3 packed0 = lerp( packed00.xyz, packed01.xyz, blendPower );
    ...
    float3 packed1 = lerp( packed10.xyz, packed11.xyz, blendPower );
