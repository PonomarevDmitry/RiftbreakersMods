...
class 'turn_on_off_by_type_base' ( tool )

function turn_on_off_by_type_base:__init()
    tool.__init(self,self)
end

function turn_on_off_by_type_base:SpawnCornerBlueprint()
    if ( self.corners == nil ) then
        self.corners = EntityService:SpawnAndAttachEntity( "misc/marker_selector_corner_tool_violet", self.entity )
    end
end

function turn_on_off_by_type_base:InitLowUpgradeList()
...
function turn_on_off_by_type_base:GetFirstLevelBuilding(blueprintName)
...
function turn_on_off_by_type_base:FillCache()
...
function turn_on_off_by_type_base:FillLowUpgradeList( list, blueprintName, seenBlueprintList )
...
function turn_on_off_by_type_base:AddToLowUpgradeList( list, buildingDescRef )
...
function turn_on_off_by_type_base:FillSelectedBlueprintsList( list, blueprintName, seenBlueprintList )
...
function turn_on_off_by_type_base:AddToSelectedBlueprintsList( list, buildingDescRef )
...
function turn_on_off_by_type_base:IsBlueprintInList( blueprintName )
...
function turn_on_off_by_type_base:CalcIsBlueprintInList( blueprintName )
...
function turn_on_off_by_type_base:IsBlueprintInLowNameList( blueprintName )
...
function turn_on_off_by_type_base:CalcIsBlueprintInLowNameList( blueprintName )
...
function turn_on_off_by_type_base:GetMenuIcon( blueprintName )
...
function turn_on_off_by_type_base:GetBuildingMenuIcon( blueprintName )
...
function turn_on_off_by_type_base:SetEntitySelectedMaterial( entity, material )
