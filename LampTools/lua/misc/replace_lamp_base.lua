...
class 'replace_lamp_base' ( tool )

function replace_lamp_base:__init()
    tool.__init(self,self)
end

function replace_lamp_base:InitBlueprintList(selectedBlueprintName, selectedBlueprints, cacheBlueprintsLowNames)
...
function replace_lamp_base:GetFirstLevelBuilding(blueprintName)
...
function replace_lamp_base:FillCache(cacheBlueprints, selectedBlueprints)
...
function replace_lamp_base:FillSelectedBlueprintsList( list, blueprintName, seenBlueprintList )
...
function replace_lamp_base:IsBlueprintInList( selectedBlueprints, cacheBlueprints, blueprintName )
...
function replace_lamp_base:CalcIsBlueprintInList( selectedBlueprints, blueprintName )
...
function replace_lamp_base:GetMenuIcon( blueprintName )
...
function replace_lamp_base:GetBuildingMenuIcon( blueprintName )
...
function replace_lamp_base:SetEntitySelectedMaterial( entity, material )
