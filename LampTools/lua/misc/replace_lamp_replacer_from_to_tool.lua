...
class 'replace_lamp_replacer_from_to_tool' ( replace_lamp_base )

function replace_lamp_replacer_from_to_tool:__init()
    replace_lamp_base.__init(self,self)
end

function replace_lamp_replacer_from_to_tool:OnInit()
...
function replace_lamp_replacer_from_to_tool:FillAllBlueprints( blueprintName )
...
function replace_lamp_replacer_from_to_tool:SetBuildingIcon()
    ...
    if ( self.fromBlueprintName ~= "" and ResourceManager:ResourceExists( "EntityBlueprint", self.fromBlueprintName ) ) then
        ...
        if ( menuIcon ~= "" ) then
            ...
            markerDB:SetString("lamp_1_name", self.missing_localization_from)
        end
    else
    ...
    if ( self.toBlueprintName ~= "" and ResourceManager:ResourceExists( "EntityBlueprint", self.toBlueprintName ) ) then
        ...
        if ( menuIcon ~= "" ) then
            ...
            markerDB:SetString("lamp_2_name", self.missing_localization_to)
        end
    else
...
function replace_lamp_replacer_from_to_tool:AddedToSelection( entity )

    self:SetEntitySelectedMaterial( entity, "hologram/pass" )
end

function replace_lamp_replacer_from_to_tool:RemovedFromSelection( entity )
...
function replace_lamp_replacer_from_to_tool:FilterSelectedEntities( selectedEntities )
...
function replace_lamp_replacer_from_to_tool:IsEntityApproved( entity )
...
function replace_lamp_replacer_from_to_tool:OnUpdate()
...
function replace_lamp_replacer_from_to_tool:FindBuildingFrom()
...
function replace_lamp_replacer_from_to_tool:OnRotate()
end

function replace_lamp_replacer_from_to_tool:OnRelease()
...
function replace_lamp_replacer_from_to_tool:OnActivateEntity( entity )
...
function replace_lamp_replacer_from_to_tool:GetLampBlueprintName( level )
...
function replace_lamp_replacer_from_to_tool:GetBuildCosts( blueprintName )
...
function replace_lamp_replacer_from_to_tool:CalculateBuildCosts( blueprintName )
...
return replace_lamp_replacer_from_to_tool