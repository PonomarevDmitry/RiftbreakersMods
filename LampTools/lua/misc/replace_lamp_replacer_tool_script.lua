...
class 'replace_lamp_replacer_tool_script' ( LuaEntityObject )

function replace_lamp_replacer_tool_script:__init()
    LuaEntityObject.__init(self, self)
end

function replace_lamp_replacer_tool_script:init()
...
function replace_lamp_replacer_tool_script:OnLoad()
...
function replace_lamp_replacer_tool_script:OnBuildingSellEndEvent()
...
function replace_lamp_replacer_tool_script:DestroySelf()
    self.targetEntity = nil
    EntityService:RemoveEntity( self.entity )
end

return replace_lamp_replacer_tool_script