...
class 'replace_wall_gate_base' ( tool )

function replace_wall_gate_base:__init()
    tool.__init(self,self)
end

function replace_wall_gate_base:InitBlueprintList(selectedBlueprintName, selectedBlueprints, cacheBlueprintsLowNames)
...
function replace_wall_gate_base:GetFirstLevelBuilding(blueprintName)
...
function replace_wall_gate_base:FillCache(cacheBlueprints, selectedBlueprints)
...
function replace_wall_gate_base:FillSelectedBlueprintsList( list, blueprintName, seenBlueprintList )
...
function replace_wall_gate_base:IsBlueprintInList( selectedBlueprints, cacheBlueprints, blueprintName )
...
function replace_wall_gate_base:CalcIsBlueprintInList( selectedBlueprints, blueprintName )
...
function replace_wall_gate_base:GetMenuIcon( blueprintName )
...
function replace_wall_gate_base:GetBuildingMenuIcon( blueprintName )
...
function replace_wall_gate_base:SetEntitySelectedMaterial( entity, material )
