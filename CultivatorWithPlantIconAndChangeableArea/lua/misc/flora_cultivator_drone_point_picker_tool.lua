...
class 'flora_cultivator_drone_point_picker_tool' ( tool )

function flora_cultivator_drone_point_picker_tool:__init()
    tool.__init(self,self)
end

function flora_cultivator_drone_point_picker_tool:OnInit()
...
function flora_cultivator_drone_point_picker_tool:GetBuildingDisplayRadius( blueprintDatabase )
...
function flora_cultivator_drone_point_picker_tool:OnPreInit()
    self.initialScale = { x=1, y=1, z=1 }
end

function flora_cultivator_drone_point_picker_tool:GetScaleFromDatabase()
    return { x=1, y=1, z=1 }
end

function flora_cultivator_drone_point_picker_tool:SpawnCornerBlueprint()
    if ( self.corners == nil ) then
        self.corners = EntityService:SpawnAndAttachEntity("misc/marker_selector_corner_tool", self.entity )
    end
end

function flora_cultivator_drone_point_picker_tool:AddedToSelection( entity )
end

function flora_cultivator_drone_point_picker_tool:RemovedFromSelection( entity )
...
function flora_cultivator_drone_point_picker_tool:SetEntitySelectedMaterial( entity, material )
...
function flora_cultivator_drone_point_picker_tool:FindEntitiesToSelect( selectorComponent )
...
function flora_cultivator_drone_point_picker_tool:FindTowerDronePointsParents(position)
...
function flora_cultivator_drone_point_picker_tool:OnActivateEntity( entity, removalEnabled, ignoreDisplayingRadiusComponent )
...
function flora_cultivator_drone_point_picker_tool:ShowDisplayRadiusComponent()
...
function flora_cultivator_drone_point_picker_tool:CreateDisplayRadiusComponent(min, max)
...
function flora_cultivator_drone_point_picker_tool:OnRotateSelectorRequest(evt)
...
function flora_cultivator_drone_point_picker_tool:ClearPickedBuildings()
...
function flora_cultivator_drone_point_picker_tool:OnRelease()
...
return flora_cultivator_drone_point_picker_tool
