...
class 'portal_builder_tool2' ( portal_base_tool )
...
function portal_builder_tool2:CheckDirectionExists( currentDirection )
...
function portal_builder_tool2:CheckSizeExists( currentSize )
...
function portal_builder_tool2:SpawnGhostEntities()
...
function portal_builder_tool2:GetEntityFromGrid( gridEntities, newPositionX, newPositionZ )
...
function portal_builder_tool2:InsertEntityToGrid( gridEntities, lineEnt, newPositionX, newPositionZ )
...
function portal_builder_tool2:HashContains( hashPositions, newPositionX, newPositionZ )
...
function portal_builder_tool2:RemoveUselessComponents(entity)
...
function portal_builder_tool2:FindPositionsToBuildLine(currentDirection, currentSize)
...
function portal_builder_tool2:AddToHash(hashPositions, newPositionX, newPositionZ)
...
function portal_builder_tool2:UpdateMarker(currentSize)
...
function portal_builder_tool2:OnUpdate()
...
function portal_builder_tool2:OnActivateSelectorRequest()
...
function portal_builder_tool2:FinishLineBuild()
...
function portal_builder_tool2:OnDeactivateSelectorRequest()
...
function portal_builder_tool2:OnRotateSelectorRequest(evt)
...
function portal_builder_tool2:OnRelease()
