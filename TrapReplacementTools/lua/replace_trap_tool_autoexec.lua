...
RegisterGlobalEventHandler("PlayerCreatedEvent", replace_trap_tool_autoexec)

RegisterGlobalEventHandler("PlayerControlledEntityChangeEvent", replace_trap_tool_autoexec)
