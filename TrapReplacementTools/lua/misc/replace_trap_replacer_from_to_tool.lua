...
class 'replace_trap_replacer_from_to_tool' ( replace_trap_base )

function replace_trap_replacer_from_to_tool:__init()
    replace_trap_base.__init(self,self)
end

function replace_trap_replacer_from_to_tool:OnInit()
...
function replace_trap_replacer_from_to_tool:FillAllBlueprints( blueprintName )
...
function replace_trap_replacer_from_to_tool:SetBuildingIcon()
    ...
    if ( self.fromBlueprintName ~= "" and ResourceManager:ResourceExists( "EntityBlueprint", self.fromBlueprintName ) ) then
        ...
        if ( menuIcon ~= "" ) then
            ...
            markerDB:SetString("trap_1_icon", menuIcon)
            markerDB:SetString("trap_1_name", buildingDescRef.localization_id)
        else

            markerDB:SetString("trap_1_icon", "gui/menu/research/icons/missing_icon_big")
            markerDB:SetString("trap_1_name", self.missing_localization_from)
        end
    else
    ...
    if ( self.toBlueprintName ~= "" and ResourceManager:ResourceExists( "EntityBlueprint", self.toBlueprintName ) ) then
        ...
        if ( menuIcon ~= "" ) then
            ...
            markerDB:SetString("trap_2_icon", menuIcon)
            markerDB:SetString("trap_2_name", buildingDescRef.localization_id)
        else

            markerDB:SetString("trap_2_icon", "gui/menu/research/icons/missing_icon_big")
            markerDB:SetString("trap_2_name", self.missing_localization_to)
        end
    else
...
function replace_trap_replacer_from_to_tool:IsEntityApproved( entity )
...
function replace_trap_replacer_from_to_tool:OnUpdate()
...
function replace_trap_replacer_from_to_tool:FindBuildingFrom()
...
function replace_trap_replacer_from_to_tool:OnRotate()
end

function replace_trap_replacer_from_to_tool:OnRelease()
...
function replace_trap_replacer_from_to_tool:OnActivateEntity( entity )
...
function replace_trap_replacer_from_to_tool:GetWallBlueprintAndLevel( level )
...
function replace_trap_replacer_from_to_tool:GetBuildCosts( level )
...
function replace_trap_replacer_from_to_tool:CalculateBuildCosts( level )
...
return replace_trap_replacer_from_to_tool