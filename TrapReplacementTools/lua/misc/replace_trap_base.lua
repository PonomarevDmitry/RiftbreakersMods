...
class 'replace_trap_base' ( tool )

function replace_trap_base:__init()
    tool.__init(self,self)
end

function replace_trap_base:InitBlueprintList(selectedBlueprintName, selectedBlueprints, cacheBlueprintsLowNames)
...
function replace_trap_base:GetFirstLevelBuilding(blueprintName)
...
function replace_trap_base:FillCache(cacheBlueprints, selectedBlueprints)
...
function replace_trap_base:FillSelectedBlueprintsList( list, blueprintName, seenBlueprintList )
...
function replace_trap_base:IsBlueprintInList( selectedBlueprints, cacheBlueprints, blueprintName )
...
function replace_trap_base:CalcIsBlueprintInList( selectedBlueprints, blueprintName )
...
function replace_trap_base:GetMenuIcon( blueprintName )
...
function replace_trap_base:GetBuildingMenuIcon( blueprintName )
...
function replace_trap_base:SetEntitySelectedMaterial( entity, material )
