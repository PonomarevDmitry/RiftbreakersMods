...
function replace_wall_replacer_all_tool:FindBuildingFrom()
...
function replace_wall_replacer_all_tool:OnRelease()
...
function replace_wall_replacer_all_tool:GetBuildCosts( level )
...
function replace_wall_replacer_all_tool:CalculateBuildCosts( level )
