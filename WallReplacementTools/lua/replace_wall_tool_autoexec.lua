...
RegisterGlobalEventHandler("PlayerCreatedEvent", replace_wall_tool_autoexec)

RegisterGlobalEventHandler("PlayerControlledEntityChangeEvent", replace_wall_tool_autoexec)
