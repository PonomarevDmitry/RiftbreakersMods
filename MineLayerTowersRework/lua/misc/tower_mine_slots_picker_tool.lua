...
class 'tower_mine_slots_picker_tool' ( tool )

function tower_mine_slots_picker_tool:__init()
    tool.__init(self,self)
end

function tower_mine_slots_picker_tool:OnInit()
...
function tower_mine_slots_picker_tool:GetSlotsArrayFromString(currentValue)
...
function tower_mine_slots_picker_tool:SetSlotsIcons(slotsArray, markerDB)
...
function tower_mine_slots_picker_tool:OnPreInit()
    self.initialScale = { x=1, y=1, z=1 }
end

function tower_mine_slots_picker_tool:GetScaleFromDatabase()
    return { x=1, y=1, z=1 }
end
...
function tower_mine_slots_picker_tool:GetSlotsValues(equipmentComponent, entity)
...
function tower_mine_slots_picker_tool:IsEqualSlots(slots1, slots2)
...
function tower_mine_slots_picker_tool:OnActivateSelectorRequest()
...
function tower_mine_slots_picker_tool:GetSlotsIndexOf( array, slots )
...
function tower_mine_slots_picker_tool:GetCurrentList(parameterName, selectorDB)
...
function tower_mine_slots_picker_tool:GetCurrentListString(parameterName, selectorDB)
...
function tower_mine_slots_picker_tool:AddSlotsToLastList(slots, selectorDB)
...
function tower_mine_slots_picker_tool:OnRotateSelectorRequest(evt)
...
function tower_mine_slots_picker_tool:CheckModeValueExists( selectedMode )
