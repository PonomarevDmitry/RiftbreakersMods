...
class 'tower_mine_slots_replacer_tool' ( tool )

function tower_mine_slots_replacer_tool:__init()
    tool.__init(self,self)
end

function tower_mine_slots_replacer_tool:OnInit()
...
function tower_mine_slots_replacer_tool:OnPreInit()
    self.initialScale = { x=8, y=1, z=8 }
end

function tower_mine_slots_replacer_tool:GetSlotsArrayFromString(currentValue)
...
function tower_mine_slots_replacer_tool:UpdateMarker()
...
function tower_mine_slots_replacer_tool:SetSlotsIcons(slotsArray, markerDB)
...
function tower_mine_slots_replacer_tool:RemovedFromSelection( entity )
...
function tower_mine_slots_replacer_tool:FilterSelectedEntities( selectedEntities )
...
function tower_mine_slots_replacer_tool:GetSlotsValues(equipmentComponent, entity)
...
function tower_mine_slots_replacer_tool:IsEqualSlots(slots1, slots2)
...
function tower_mine_slots_replacer_tool:OnActivateEntity( entity )
...
return tower_mine_slots_replacer_tool
