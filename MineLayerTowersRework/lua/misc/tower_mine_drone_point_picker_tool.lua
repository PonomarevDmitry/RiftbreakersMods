...
function tower_mine_drone_point_picker_tool:GetBuildingDisplayRadius( blueprintDatabase )
...
function tower_mine_drone_point_picker_tool:ShowBuildingDisplayRadiusWithoutGroup()
...
function tower_mine_drone_point_picker_tool:FindBuildingLowUpgrade()
...
function tower_mine_drone_point_picker_tool:CreateDisplayRadiusComponent(min, max)
