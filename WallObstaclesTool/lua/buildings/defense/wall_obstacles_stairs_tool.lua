...
class 'wall_obstacles_stairs_tool' ( LuaEntityObject )

function wall_obstacles_stairs_tool:__init()
    LuaEntityObject.__init(self,self)
end

function wall_obstacles_stairs_tool:init()
...
function wall_obstacles_stairs_tool:InitializeValues()
    ...
    self:SpawnWallTemplates( self.wallBlueprintName, self.stairsBlueprintName )
...
function wall_obstacles_stairs_tool:GetWallBlueprintName( selectorDB )
...
function wall_obstacles_stairs_tool:SpawnWallTemplates(wallBlueprintName, stairsBlueprintName)
    ...
    buildingDesc = reflection_helper( BuildingService:GetBuildingDesc( stairsBlueprintName ) )
...
function wall_obstacles_stairs_tool:SpawnGhostWallEntity()
...
function wall_obstacles_stairs_tool:DestroyGhostWall()
...
function wall_obstacles_stairs_tool:OnWorkExecute()
...
function wall_obstacles_stairs_tool:GetXZSigns(positionStart, positionEnd)
...
function wall_obstacles_stairs_tool:AddToEntitiesToSellList(testBuildable)
...
function wall_obstacles_stairs_tool:CheckEntityBuildable( entity, transform, id )
...
function wall_obstacles_stairs_tool:BuildEntity(entity, createCube)
...
function wall_obstacles_stairs_tool:RemoveMaterialFromOldBuildingsToSell()
