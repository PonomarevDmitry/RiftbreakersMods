...
local floor_desert_under_buildings_tool_autoexec = function(evt)
    ...
    for i=1,unlocks.count do
        ...
        if ( unlocked == "floor_desert_under_buildings_tool" ) then
    ...
    if (hasBuilding) then
        ...
        BuildingService:UnlockBuilding("buildings/decorations/floor_desert_under_buildings_tool")
    end
end

RegisterGlobalEventHandler("PlayerCreatedEvent", function(evt)

    floor_desert_under_buildings_tool_autoexec(evt)
end)
