class 'cosmic_meteor_shower' ( LuaEntityObject )

function cosmic_meteor_shower:__init()
	LuaEntityObject.__init(self, self)
end

function cosmic_meteor_shower:init()
	self.meteorBp			= self.data:GetString( "cosmic_meteor_small_blueprint" )
...
function cosmic_meteor_shower:OnLoad()
	self.speed				= self.data:GetFloatOrDefault( "speed", 140 )
	self.spread				= self.data:GetFloatOrDefault( "spread", 15 )
end

function cosmic_meteor_shower:OnEecuteInterpolation( state, dt )
...
function cosmic_meteor_shower:OnEnterSpawn( state )
...
function cosmic_meteor_shower:OnExitSpawn( state )
