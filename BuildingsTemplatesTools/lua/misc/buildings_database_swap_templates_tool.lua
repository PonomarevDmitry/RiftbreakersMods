...
class 'buildings_database_swap_templates_tool' ( buildings_tool_base )

function buildings_database_swap_templates_tool:__init()
    buildings_tool_base.__init(self,self)
end

function buildings_database_swap_templates_tool:OnInit()
    ...
    self.childEntity = EntityService:SpawnAndAttachEntity( "misc/marker_selector_buildings_database_swap_templates_tool", self.selector )
...
function buildings_database_swap_templates_tool:FillMarkerMessage()
    ...
    do
        ...
        local templateCaption = "gui/hud/building_templates/persistent_template_" .. self.selectedTemplateFrom
...
function buildings_database_swap_templates_tool:RemovedFromSelection( entity )
end

function buildings_database_swap_templates_tool:OnUpdate()
end

function buildings_database_swap_templates_tool:FindEntitiesToSelect( selectorComponent )

    return {}
end

function buildings_database_swap_templates_tool:OnRotateSelectorRequest(evt)
...
function buildings_database_swap_templates_tool:CheckTemplateExists( selectedTemplate, templatesArray )
...
function buildings_database_swap_templates_tool:GetTemplatesArray()
...
function buildings_database_swap_templates_tool:OnRelease()
...
return buildings_database_swap_templates_tool