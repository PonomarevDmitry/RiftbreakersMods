...
function buildings_tool_base:GetAvailableBlueprintsInTemplate(currentTemplateString)
...
function buildings_tool_base:GetUnlockedOrMaxAvailableLevel( blueprintName, unlockedHash )
...
function buildings_tool_base:CleanInformationTemplateEntities()

    self.templateEntities = self.templateEntities or {}
...
function buildings_tool_base:SpawnInformationBuildinsTemplates(templateString)
    ...
    for template in Iter( blueprintsGroupsArray ) do
        ...
        for entityString in Iter( entitiesCoordinatesArray ) do
            ...
            self:CreateSingleInformationBuildingTemplate( blueprintName, buildingDescRef, createCube, entityString, buildCosts, delimiterBetweenCoordinates )
        end
...
function buildings_tool_base:CreateSingleInformationBuildingTemplate( blueprintName, buildingDesc, createCube, entityString, buildCosts, delimiterBetweenCoordinates )
...
function buildings_tool_base:OnRelease()
