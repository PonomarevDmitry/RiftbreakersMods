RegisterGlobalEventHandler("PlayerCreatedEvent", function(evt)
    ...
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_02")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_03")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_04")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_05")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_06")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_07")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_08")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_09")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_10")

    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_11")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_12")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_13")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_14")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_15")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_16")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_17")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_18")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_19")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_20")

    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_21")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_22")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_23")
    BuildingService:UnlockBuilding("buildings/tools/buildings_upgrader_24")
end)