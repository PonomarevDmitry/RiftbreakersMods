...
| [float](/riftbreaker-wiki/docs/game-reflection/components/float/) | dissipation_damage |
| [float](/riftbreaker-wiki/docs/game-reflection/components/float/) | diameter |
| [bool](/riftbreaker-wiki/docs/game-reflection/components/bool/) | use_dissipation_damage |
| [bool](/riftbreaker-wiki/docs/game-reflection/components/bool/) | accumulate_damage |
