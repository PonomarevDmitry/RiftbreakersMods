...
class 'drone_weaponize_player' ( base_drone )

function drone_weaponize_player:__init()
	base_drone.__init(self,self)
end

function drone_weaponize_player:OnInit()
	self:FillInitialParams()
end

function drone_weaponize_player:OnLoad()
...
function drone_weaponize_player:FillInitialParams()
...
function drone_weaponize_player:OnWorkInProgress()
...
function drone_weaponize_player:GetDiscoveryDistance( entity )
...
function drone_weaponize_player:FindActionTarget()
...
function drone_weaponize_player:FindNearestTreaure()
...
function drone_weaponize_player:OnDroneTargetAction( target )
...
function drone_weaponize_player:OnFollowExecute(state)
...
function drone_weaponize_player:IsDiscovered( target )
...
function drone_weaponize_player:GetModeFromFactor( factor )
	if ( factor > 2.0 ) then
		return 1
...
function drone_weaponize_player:CheckAndSpawnEffect( ent, type, factor )
...
function drone_weaponize_player:OnRelease()
