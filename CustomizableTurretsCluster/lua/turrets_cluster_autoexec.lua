...
RegisterGlobalEventHandler("PlayerCreatedEvent", turrets_cluster_autoexec)

RegisterGlobalEventHandler("PlayerControlledEntityChangeEvent", turrets_cluster_autoexec)