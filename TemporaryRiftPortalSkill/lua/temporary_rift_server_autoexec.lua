...
local temporary_rift_autoexec = function(evt, eventName)
...
RegisterGlobalEventHandler("PlayerCreatedEvent", function(evt)
    ...
    temporary_rift_autoexec(evt, "PlayerCreatedEvent")
end)

RegisterGlobalEventHandler("PlayerInitializedEvent", function(evt)

    temporary_rift_autoexec(evt, "PlayerInitializedEvent")
end)

RegisterGlobalEventHandler("PlayerControlledEntityChangeEvent", function(evt)

    temporary_rift_autoexec(evt, "PlayerControlledEntityChangeEvent")
end)