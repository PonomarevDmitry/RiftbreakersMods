return function()
	...
	{
		{ name = "logic/objectives/destroy_nest_mushbit_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_mushbit_multiple_campaign_HQ.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_granan_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_granan_multiple_campaign_HQ.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_morirot_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_morirot_multiple_campaign_HQ.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_bradron_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_bradron_multiple_campaign_HQ.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_flurian_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_flurian_multiple_campaign_HQ.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_octabit_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_octabit_multiple_campaign_HQ.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_wingmite_single_campaign_HQ.logic", minDifficultyLevel = 3, maxDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_wingmite_multiple_campaign_HQ.logic", minDifficultyLevel = 6 }
	}	
