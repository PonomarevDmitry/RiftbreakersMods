return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "shegret_attack", type = "NEGATIVE", gameStates="IDLE|STREAMING", minEventLevel = 6, logicFile="logic/event/shegret_attack.logic", weight = 5 },
		{ action = "shegret_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 6, logicFile="logic/event/shegret_attack.logic", weight = 5 },
	...
	rules.objectivesLogic = 
	{
		...
		{ name = "logic/objectives/kill_elite_arachnoid_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/kill_elite_baxmoth_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/kill_elite_flurian_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/kill_elite_krocoon_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/kill_elite_nerilian_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/kill_elite_stregaros_campaign_HQ.logic", minDifficultyLevel = 5 },
		...
		{ name = "logic/objectives/destroy_magma_creeper_campaign_HQ.logic", minDifficultyLevel = 5 }
	}
