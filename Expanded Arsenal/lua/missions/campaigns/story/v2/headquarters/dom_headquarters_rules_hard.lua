return function()
	...
	{
		{ name = "logic/objectives/destroy_nest_mushbit_single_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/destroy_nest_granan_single_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/destroy_nest_morirot_single_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/destroy_nest_bradron_single_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/destroy_nest_flurian_single_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/destroy_nest_octabit_single_campaign_HQ.logic", minDifficultyLevel = 5 },
		{ name = "logic/objectives/destroy_nest_wingmite_single_campaign_HQ.logic", minDifficultyLevel = 5 }
	}	
