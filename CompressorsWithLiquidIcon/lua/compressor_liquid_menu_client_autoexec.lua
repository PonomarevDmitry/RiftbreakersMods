...
local eventHandler = function(evt)
    ...
    if ( blueprintName == "buildings/resources/liquid_compressor"
        or blueprintName == "buildings/resources/liquid_compressor_lvl_2"
        or blueprintName == "buildings/resources/liquid_compressor_lvl_3"
    ) then

        CreateMenuEntity(entity, "misc/compressor_liquid_menu")
    end
...
local attachMenuToAll = function(evt)
    ...
    local entities = FindService:FindEntitiesByBlueprint( "buildings/resources/liquid_compressor" )
    ...
    local entities = FindService:FindEntitiesByBlueprint( "buildings/resources/liquid_compressor_lvl_2" )
    ...
    local entities = FindService:FindEntitiesByBlueprint( "buildings/resources/liquid_compressor_lvl_3" )
