...
class 'sell_all_map_base' ( tool )

function sell_all_map_base:__init()
    tool.__init(self,self)
end

function sell_all_map_base:InitLowUpgradeList()
...
function sell_all_map_base:FillCache()
...
function sell_all_map_base:FillLowUpgradeList( list, blueprintName, seenBlueprintList )
...
function sell_all_map_base:AddToLowUpgradeList( list, buildingDescRef )
...
function sell_all_map_base:FillSelectedBlueprintsList( list, blueprintName, seenBlueprintList )
...
function sell_all_map_base:AddToSelectedBlueprintsList( list, buildingDescRef )
...
function sell_all_map_base:IsBlueprintInList( blueprintName )
...
function sell_all_map_base:CalcIsBlueprintInList( blueprintName )
...
function sell_all_map_base:IsBlueprintInLowNameList( blueprintName )
...
function sell_all_map_base:CalcIsBlueprintInLowNameList( blueprintName )
...
function sell_all_map_base:GetMenuIcon( blueprintName )
...
function sell_all_map_base:GetBuildingMenuIcon( blueprintName, buildingDescRef )
...
function sell_all_map_base:CalculateBuildingMenuIcon( blueprintName, buildingDescRef )
...
function sell_all_map_base:SetEntitySelectedMaterial( entity, material )
