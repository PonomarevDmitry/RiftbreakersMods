...
class 'sell_all_map_picker_tool' ( sell_all_map_base )

function sell_all_map_picker_tool:__init()
    sell_all_map_base.__init(self,self)
end

function sell_all_map_picker_tool:OnPreInit()
    self.initialScale = { x=1, y=1, z=1 }
end

function sell_all_map_picker_tool:GetScaleFromDatabase()
    return { x=1, y=1, z=1 }
end

function sell_all_map_picker_tool:OnInit()
...
function sell_all_map_picker_tool:SetBuildingIcon()
...
function sell_all_map_picker_tool:RemovedFromSelection( entity )
...
function sell_all_map_picker_tool:FilterSelectedEntities( selectedEntities )
...
function sell_all_map_picker_tool:OnUpdate()
end

function sell_all_map_picker_tool:OnActivateSelectorRequest()
...
function sell_all_map_picker_tool:ChangeSelector(blueprintName)
...
function sell_all_map_picker_tool:FillLastBuildingsList(defaultModesArray, modeBuildingLastSelected, selector)
...
function sell_all_map_picker_tool:AddBlueprintToLastList(blueprintName, selector)

    LastSelectedBlueprintsListUtils:AddBlueprintToList(self.list_name, selector, blueprintName)
end

function sell_all_map_picker_tool:OnRotateSelectorRequest(evt)
...
function sell_all_map_picker_tool:CheckModeValueExists( selectedMode )
...
function sell_all_map_picker_tool:OnRelease()
...
return sell_all_map_picker_tool
