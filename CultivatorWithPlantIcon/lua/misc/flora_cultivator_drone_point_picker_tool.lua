...
function flora_cultivator_drone_point_picker_tool:OnInit()
    self.childEntity = EntityService:SpawnAndAttachEntity("misc/marker_selector_flora_cultivator_drone_point_picker_tool", self.entity)
...
function flora_cultivator_drone_point_picker_tool:OnActivateEntity( entity )
