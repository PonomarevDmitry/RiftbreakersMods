...
RegisterGlobalEventHandler("OperateActionMapperRequest", function(evt)
    ...
    local stringNumber = string.find( mapperName, "AutoMinesLayingPanelOnOperateActionMenu" )
    ...
    if ( stringNumber == 1 ) then
        ...
        local skillName = blueprintDatabase:GetStringOrDefault("skill_name", "items/skills/auto_mines_laying_1_item")
