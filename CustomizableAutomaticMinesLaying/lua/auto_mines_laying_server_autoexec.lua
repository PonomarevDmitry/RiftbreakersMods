...
local auto_mines_laying_autoexec = function(evt, eventName)
...
RegisterGlobalEventHandler("PlayerCreatedEvent", function(evt)
    ...
    auto_mines_laying_autoexec(evt, "PlayerCreatedEvent")
end)

RegisterGlobalEventHandler("PlayerInitializedEvent", function(evt)

    auto_mines_laying_autoexec(evt, "PlayerInitializedEvent")
end)

RegisterGlobalEventHandler("PlayerControlledEntityChangeEvent", function(evt)

    auto_mines_laying_autoexec(evt, "PlayerControlledEntityChangeEvent")
end)