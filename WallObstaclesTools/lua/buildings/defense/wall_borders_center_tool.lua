...
class 'wall_borders_center_tool' ( wall_base_tool )

function wall_borders_center_tool:__init()
    wall_base_tool.__init(self,self)
end

function wall_borders_center_tool:OnInit()
...
function wall_borders_center_tool:OnUpdate()
    ...
    if ( self.buildStartTransform ) then
...
function wall_borders_center_tool:GetEntityFromGrid( gridEntities, newPositionX, newPositionZ )
...
function wall_borders_center_tool:InsertEntityToGrid( gridEntities, lineEnt, newPositionX, newPositionZ )
...
function wall_borders_center_tool:HashContains( hashPositions, newPositionX, newPositionZ )
...
function wall_borders_center_tool:FindPositionsToBuildLine( pointPosition, wallLinesConfig )

    local buildStartPosition = pointPosition
    local buildEndPosition = {}
    buildEndPosition.x = pointPosition.x + 2 * (self.buildStartTransform.position.x - pointPosition.x)
    buildEndPosition.z = pointPosition.z + 2 * (self.buildStartTransform.position.z - pointPosition.z)

    local xSign, zSign = self:GetXZSigns( buildStartPosition, buildEndPosition )

    local arrayX, arrayZ = self:FindGridArrays( buildStartPosition, buildEndPosition )

    local buildStartPositionX = buildStartPosition.x
    local buildStartPositionZ = buildStartPosition.z
...
function wall_borders_center_tool:AddCornerPositions(wallLinesConfig, positionX, positionY, positionZ, xSign, zSign, deltaXZ, hashPositions, result)
...
function wall_borders_center_tool:AddNewPositionsByXArray(wallLinesConfig, arrayX, positionY, positionZ, zSign, deltaXZ, hashPositions, result)
...
function wall_borders_center_tool:AddNewPositionsByZArray(wallLinesConfig, positionX, positionY, arrayZ, xSign, deltaXZ, hashPositions, result)
...
function wall_borders_center_tool:AddNewPositionsByConfigByX(position, wallLinesConfig, xSign, deltaXZ, hashPositions, result)
...
function wall_borders_center_tool:AddNewPositionsByConfigByZ(position, wallLinesConfig, zSign, deltaXZ, hashPositions, result)
...
function wall_borders_center_tool:FindGridArrays(buildStartPosition, buildEndPosition)
...
function wall_borders_center_tool:AddNewPositionToResult(hashPositions, result, newPositionX, newPositionZ, newPositionY)
...
function wall_borders_center_tool:AddToHash(hashPositions, newPositionX, newPositionZ)
...
function wall_borders_center_tool:CheckConfigExists( wallLinesConfig )
...
function wall_borders_center_tool:GetWallConfigArray()
...
function wall_borders_center_tool:OnActivateSelectorRequest()
...
function wall_borders_center_tool:OnDeactivateSelectorRequest()
    self:FinishLineBuild()

    self:RemoveMaterialFromOldBuildingsToSell()
end

function wall_borders_center_tool:FinishLineBuild()
...
function wall_borders_center_tool:DestroyPositionCenterMarker()
...
function wall_borders_center_tool:OnRotateSelectorRequest(evt)
...
function wall_borders_center_tool:OnRelease()
...
return wall_borders_center_tool