...
RegisterGlobalEventHandler("OperateActionMapperRequest", function(evt)
    ...
    local stringNumber = string.find( mapperName, "GrenadesPackPanelOnOperateActionMenu" )
    ...
    if ( stringNumber == 1 ) then
        ...
        local skillName = blueprintDatabase:GetStringOrDefault("skill_name", "items/skills/grenades_pack_1_item")
