...
RegisterGlobalEventHandler("PlayerCreatedEvent", grenades_pack_autoexec)

RegisterGlobalEventHandler("PlayerControlledEntityChangeEvent", grenades_pack_autoexec)