...
function event_manager:SpawnEvent( action, participants )
	...
	if ( translatedEventName == "spawn_acid_rain" ) or 
		...
		--CAVERNS EVENTS END
		--ARCTIC EVENTS START
		( translatedEventName == "spawn_arctic_blizzard" ) or
		( translatedEventName == "spawn_arctic_heavy_snow" ) or
		( translatedEventName == "spawn_arctic_heavy_hail" ) or
		( translatedEventName == "spawn_arctic_rock_rain" ) or
		( translatedEventName == "spawn_arctic_fog" ) or
		( translatedEventName == "spawn_comet_boss_random_ta" ) or
		( translatedEventName == "comet_random_bosses" ) or
		( translatedEventName == "spawn_ta_snow_storm" ) or
		( translatedEventName == "spawn_cryogenic_tornado_near_player" ) or
		( translatedEventName == "spawn_cryogenic_tornado_near_base" ) or
		--ARCTIC EVENTS END
		--THE_ABYS EVENTS START
		( translatedEventName == "cosmic_kermon_attack" ) or
		( translatedEventName == "cosmic_phirian_attack" ) or
		( translatedEventName == "cosmic_stregaros_crystal_attack" ) or
		( translatedEventName == "cosmic_crawlog_attack" ) or
		( translatedEventName == "spawn_comet_boss_random_ta" ) or
		( translatedEventName == "spawn_cosmic_comet_silent" ) or
