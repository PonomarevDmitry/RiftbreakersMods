...
function mission_ArcticIslands_alien_base:init()
    ...
    MissionService:ActivateMissionFlow("", "logic/missions/campaigns/dlc_1/ArcticIslands_alien_base.logic", "default" )

    local rulesPath = GetRulesForDifficulty( "lua/missions/campaigns/dlc_1/dom_ArcticIslands_alien_base_rules_" )
