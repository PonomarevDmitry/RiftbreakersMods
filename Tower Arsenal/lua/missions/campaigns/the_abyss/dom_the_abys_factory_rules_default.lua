return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_resource_earthquake", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 6, logicFile="logic/weather/resource_earthquake.logic", minTime = 60, maxTime = 60, weight = 0.5 },
		{ action = "spawn_resource_earthquake", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 6, logicFile="logic/weather/resource_earthquake.logic", minTime = 60, maxTime = 60, weight = 0.5 },
