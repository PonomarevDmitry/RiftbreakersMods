return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_ion_storm", type = "POSITIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/ion_storm.logic", minTime = 30, maxTime = 60, weight = 2 },
		...
		{ action = "spawn_cosmic_tornado_near_player", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 2, maxEventLevel = 6, logicFile="logic/weather/cosmic_tornado_near_player.logic", weight = 1 },
		{ action = "spawn_cosmic_tornado_near_player", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 2, maxEventLevel = 6, logicFile="logic/weather/cosmic_tornado_near_player.logic", weight = 1 },
		...
		--{ action = "spawn_cosmic_moon", type = "NEGATIVE", gameStates="IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/cosmic_moon.logic", weight = 2 },
		--{ action = "spawn_cosmic_moon", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/cosmic_moon.logic", weight = 2 },
