return function()
	...
	{			
		{ level = 4, minLevel = 6, prepareTime = 120, entryLogic = "logic/dom/major_attack_1_entry.logic", exitLogic = "logic/dom/major_attack_1_exit.logic" },
	}
	...
	{			
		...
		7,  -- difficulty level 4
		7,  -- difficulty level 5
		8,  -- difficulty level 6
		9,  -- difficulty level 7
		9,  -- difficulty level 8
