return function()
	...
	rules.baseTimeBetweenObjectives = 300
	...
	rules.gameEvents = 
	{
		...
		{ action = "cosmic_crawlog_attack", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 3, maxEventLevel = 9, logicFile="logic/event/cosmic_crawlog_attack.logic", weight = 2 },
		{ action = "cosmic_crawlog_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 3, maxEventLevel = 9, logicFile="logic/event/cosmic_crawlog_attack.logic", weight = 2 },
		{ action = "cosmic_stregaros_crystal_attack", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 7, maxEventLevel = 9, logicFile="logic/event/cosmic_stregaros_crystal_attack.logic", weight = 3 },
		{ action = "cosmic_stregaros_crystal_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 7, maxEventLevel = 9, logicFile="logic/event/cosmic_stregaros_crystal_attack.logic", weight = 3 },
		{ action = "cosmic_kermon_attack", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 5, maxEventLevel = 9, logicFile="logic/event/cosmic_kermon_attack.logic", weight = 3 },
		{ action = "cosmic_kermon_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 5, maxEventLevel = 9, logicFile="logic/event/cosmic_kermon_attack.logic", weight = 3 },
		{ action = "cosmic_phirian_attack", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 6, maxEventLevel = 9, logicFile="logic/event/cosmic_phirian_attack.logic", weight = 3 },
		{ action = "cosmic_phirian_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 6, maxEventLevel = 9, logicFile="logic/event/cosmic_phirian_attack.logic", weight = 3 },
		{ action = "spawn_cosmic_meteor_shower", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 5, logicFile="logic/weather/comsic_meteor_shower.logic", minTime = 30, maxTime = 60, weight = 2 },
		{ action = "spawn_cosmic_meteor_shower", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 5, logicFile="logic/weather/cosmic_meteor_shower.logic", minTime = 30, maxTime = 60, weight = 2 },
		...
		{ action = "spawn_cosmic_tornado_near_base", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 2, logicFile="logic/weather/cosmic_tornado_near_base.logic", weight = 0.25 },
		{ action = "spawn_cosmic_tornado_near_base", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/cosmic_tornado_near_base.logic", weight = 0.1 },
		{ action = "spawn_cryogenic_tornado_near_base", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 2, logicFile="logic/weather/cryogenic_tornado_near_base.logic", weight = 0.25 },
		{ action = "spawn_cryogenic_tornado_near_base", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/cryogenic_tornado_near_base.logic", weight = 0.1 },
		{ action = "spawn_tornado_fire_near_base", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 8, logicFile="logic/weather/tornado_fire_near_base.logic", weight = 0.25 },
		{ action = "spawn_tornado_fire_near_base", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 8, logicFile="logic/weather/tornado_fire_near_base.logic", weight = 0.1 },
		{ action = "spawn_tornado_acid_near_base", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 8, logicFile="logic/weather/tornado_acid_near_base.logic", weight = 0.25 },
		{ action = "spawn_tornado_acid_near_base", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 8, logicFile="logic/weather/tornado_acid_near_base.logic", weight = 0.1 },		
		{ action = "spawn_cosmic_moon", type = "NEGATIVE", gameStates="IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/cosmic_moon.logic", minTime = 180, maxTime = 240, weight = 3 },
		{ action = "spawn_cosmic_moon", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/cosmic_moon.logic", minTime = 180, maxTime = 240, weight = 3 },
		{ action = "spawn_cosmic_comet_silent", type = "POSITIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/cosmic_comet_silent.logic", weight = 2 },
	}
	...
	{			
		{ level = 2, minLevel = 2, prepareTime = 300, entryLogic = "logic/dom/major_attack_1_entry.logic", exitLogic = "logic/dom/major_attack_1_exit.logic" },
	}
	...
	rules.objectivesLogic = 
	{
		...
		{ name = "logic/objectives/destroy_cryogenic_crystal_creeper.logic", minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_cosmic_canoptrix_single.logic", minDifficultyLevel = 2, maxDifficultyLevel = 3 },
		{ name = "logic/objectives/destroy_nest_cosmic_canoptrix_multiple.logic", minDifficultyLevel = 3 },
		{ name = "logic/objectives/destroy_nest_cosmic_morirot_single.logic", minDifficultyLevel = 2, maxDifficultyLevel = 3 },
		{ name = "logic/objectives/destroy_nest_cosmic_morirot_multiple.logic", minDifficultyLevel = 3 },
		{ name = "logic/objectives/destroy_nest_cosmic_magmoth_multiple.logic", minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_cosmic_lesigian_multiple.logic", minDifficultyLevel = 6 },
		{ name = "logic/objectives/destroy_nest_cosmic_kafferroceros_multiple.logic", minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_cosmic_kermon_multiple.logic", minDifficultyLevel = 6 },
		...
		{ name = "logic/objectives/destroy_nest_cosmic_baxmoth_multiple.logic", minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_cosmic_phirian_multiple.logic", minDifficultyLevel = 6 }
	}
	...
	rules.extraWaves = 
	{
		 -- difficulty level 1		
		{ 
			"logic/missions/survival/metallic/attack_level_1_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_1_id_2_arctic.logic",
		},
	
		 -- difficulty level 2
		{ 			
			"logic/missions/survival/metallic/attack_level_2_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_2_id_2_arctic.logic",
		},

		 -- difficulty level 3
		{ 
			"logic/missions/survival/metallic/attack_level_3_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_3_id_2_arctic.logic",
			"logic/missions/survival/metallic/attack_level_3_id_3_arctic.logic",
		},

		 -- difficulty level 4
		{ 			
			"logic/missions/survival/metallic/attack_level_4_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_4_id_2_arctic.logic",
			"logic/missions/survival/metallic/attack_level_4_id_3_arctic.logic",
		},

		 -- difficulty level 5
		{ 
			"logic/missions/survival/metallic/attack_level_5_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_5_id_2_arctic.logic",			
			"logic/missions/survival/metallic/attack_level_5_id_3_arctic.logic",								
		},

		 -- difficulty level 6
		{ 
			"logic/missions/survival/metallic/attack_level_6_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_6_id_2_arctic.logic",			
			"logic/missions/survival/metallic/attack_level_6_id_3_arctic.logic",								
		},

		 -- difficulty level 7
		{ 
			"logic/missions/survival/metallic/attack_level_7_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_7_id_2_arctic.logic",
			"logic/missions/survival/metallic/attack_level_7_id_3_arctic.logic",			
		},

		 -- difficulty level 8
		{ 
			"logic/missions/survival/metallic/attack_level_8_id_1_arctic.logic",
			"logic/missions/survival/metallic/attack_level_8_id_2_arctic.logic",
			"logic/missions/survival/metallic/attack_level_8_id_3_arctic.logic",			
		},
