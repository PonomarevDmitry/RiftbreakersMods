return function()
	...
	rules.waves = 
	{
		...
		["ArcticIslands"]	= require("lua/missions/campaigns/open/headquarters/dom_waves_arctic_hard.lua"),
		["the_abys"]		= require("lua/missions/campaigns/open/headquarters/dom_waves_the_abys_hard.lua"),
	}
