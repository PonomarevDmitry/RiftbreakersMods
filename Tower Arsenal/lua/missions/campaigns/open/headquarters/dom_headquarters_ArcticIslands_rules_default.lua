return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_cryogenic_tornado_near_player", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/cryogenic_tornado_near_player.logic", minTime = 30, maxTime = 60, weight = 1 },
		{ action = "spawn_cryogenic_tornado_near_player", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/cryogenic_tornado_near_player.logic", minTime = 30, maxTime = 60, weight = 1 },
		{ action = "spawn_cryogenic_tornado_near_base", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 2, logicFile="logic/weather/cryogenic_tornado_near_base.logic", minTime = 30, maxTime = 60, weight = 0.5 },
		{ action = "spawn_cryogenic_tornado_near_base", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/cryogenic_tornado_near_base.logic", minTime = 30, maxTime = 60, weight = 0.5 },
	...
	rules.multiplayerWaves = 
	{
		...
		{ 
			...
			waves = 
			{
				{ name="logic/missions/survival/attack_cosmic_boss_dynamic.logic", spawn_type="RandomBorderInDistance", spawn_type_value=nil, target_type="Type", target_type_value="headquarters", target_min_radius=180.0, target_max_radius=350.0},
			}
		},
		...
		{ 
			...
			waves = 
			{
				{ name="logic/missions/survival/attack_cosmic_boss_dynamic.logic", spawn_type="RandomBorderInDistance", spawn_type_value=nil, target_type="Type", target_type_value="headquarters", target_min_radius=180.0, target_max_radius=384.0},
			}
		},
		 -- difficulty level 3
		{ 
			...
			waves = 
			{
				{ name="logic/missions/survival/attack_cosmic_boss_dynamic.logic", spawn_type="RandomBorderInDistance", spawn_type_value=nil, target_type="Type", target_type_value="headquarters", target_min_radius=180.0, target_max_radius=420.0},
			}
		},
		...
		{ 
			...
			waves = 
			{
				{ name="logic/missions/survival/attack_cosmic_boss_dynamic.logic", spawn_type="RandomBorderInDistance", spawn_type_value=nil, target_type="Type", target_type_value="headquarters", target_min_radius=180.0, target_max_radius=500.0},
			}
		},
		...
		{ 
			...
			waves = 
			{
				{ name="logic/missions/survival/attack_cosmic_boss_dynamic.logic", spawn_type="RandomBorderInDistance", spawn_type_value=nil, target_type="Type", target_type_value="headquarters", target_min_radius=180.0, target_max_radius=600.0},
			}
		},
		...
		{ 
			...
			waves = 
			{
				{ name="logic/missions/survival/attack_cosmic_boss_dynamic.logic", spawn_type="RandomBorderInDistance", spawn_type_value=nil, target_type="Type", target_type_value="headquarters", target_min_radius=180.0, target_max_radius=700.0},
			}
		},
	...
	rules.waves = 
	{
		["default"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_ice_normal.lua"),			
		["acid"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_acid_normal.lua"),		
		["caverns"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_caverns_normal.lua"),	
		["desert"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_desert_normal.lua"),		
		["ice"]				= require("lua/missions/campaigns/open/headquarters/dom_waves_ice_normal.lua"),	
		["jungle"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_jungle_normal.lua"),	
		["magma"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_magma_normal.lua"),		
		["metallic"]		= require("lua/missions/campaigns/open/headquarters/dom_waves_metallic_normal.lua"),
		["swamp"]			= require("lua/missions/campaigns/open/headquarters/dom_waves_swamp_normal.lua"),
		["ArcticIslands"]	= require("lua/missions/campaigns/open/headquarters/dom_waves_arctic_normal.lua"),
		["the_abys"]		= require("lua/missions/campaigns/open/headquarters/dom_waves_the_abys_normal.lua"),
	}
