return function()
	...
	{
		{ name = "logic/objectives/kill_elite.logic", minDifficultyLevel = 2 },
		...
		--{ name = "logic/objectives/destroy_nest_granan_single.logic", minDifficultyLevel = 2, maxDifficultyLevel = 3 }, 
