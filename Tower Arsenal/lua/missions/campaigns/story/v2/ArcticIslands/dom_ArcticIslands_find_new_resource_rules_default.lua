return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_cosmic_rock_rain", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 2, logicFile="logic/weather/cosmic_rock_rain.logic", weight = 2 },
		{ action = "spawn_cosmic_rock_rain", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 2, logicFile="logic/weather/cosmic_rock_rain.logic", weight = 2 },
