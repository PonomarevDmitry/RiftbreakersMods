return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_cosmic_tornado_near_player", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, maxEventLevel = 5, logicFile="logic/weather/cosmic_tornado_near_player.logic", weight = 1 },
		{ action = "spawn_cosmic_tornado_near_player", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, maxEventLevel = 5, logicFile="logic/weather/cosmic_tornado_near_player.logic", weight = 1 },
