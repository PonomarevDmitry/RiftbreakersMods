return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "spawn_arctic_fog", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/arctic_fog.logic", minTime = 60, maxTime = 120, weight = 1 },
		{ action = "spawn_arctic_fog", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/arctic_fog.logic", minTime = 60, maxTime = 120, weight = 1 },
		{ action = "spawn_arctic_heavy_hail", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, logicFile="logic/weather/arctic_heavy_hail.logic", minTime = 30, maxTime = 60, weight = 4 },
		{ action = "spawn_arctic_heavy_hail", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/weather/arctic_heavy_hail.logic", minTime = 30, maxTime = 60, weight = 4 },
		{ action = "spawn_arctic_blizzard", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, logicFile="logic/weather/arctic_blizzard.logic", minTime = 60, maxTime = 120, weight = 1.5 },
		{ action = "spawn_arctic_blizzard", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/arctic_blizzard.logic", minTime = 60, maxTime = 120, weight = 1.5 },
		{ action = "spawn_arctic_heavy_snow", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, logicFile="logic/weather/arctic_heavy_snow.logic", minTime = 60, maxTime = 120, weight = 1.2 },
		{ action = "spawn_arctic_heavy_snow", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, logicFile="logic/weather/arctic_heavy_snow.logic", minTime = 60, maxTime = 120, weight = 1.2 },		
