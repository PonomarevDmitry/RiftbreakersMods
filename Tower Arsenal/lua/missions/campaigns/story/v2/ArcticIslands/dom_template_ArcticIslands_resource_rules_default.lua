return function()
	...
	rules.gameEvents = 
	{
		...
		{ action = "cosmic_crawlog_attack", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, maxEventLevel = 7, logicFile="logic/event/cosmic_crawlog_attack.logic", weight = 2 },
		{ action = "cosmic_crawlog_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, maxEventLevel = 7, logicFile="logic/event/cosmic_crawlog_attack.logic", weight = 2 },
		...
		{ action = "cosmic_stregaros_crystal_attack", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 4, maxEventLevel = 7, logicFile="logic/event/cosmic_stregaros_crystal_attack.logic", weight = 3 },
		{ action = "cosmic_stregaros_crystal_attack", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 4, maxEventLevel = 7, logicFile="logic/event/cosmic_stregaros_crystal_attack.logic", weight = 3 },
		...
		{ action = "spawn_cosmic_tornado_near_player", type = "NEGATIVE", gameStates="ATTACK|IDLE|STREAMING", minEventLevel = 1, maxEventLevel = 6, logicFile="logic/weather/cosmic_tornado_near_player.logic", weight = 1 },
		{ action = "spawn_cosmic_tornado_near_player", type = "NEGATIVE", gameStates="IDLE|NO_STREAMING", minEventLevel = 1, maxEventLevel = 6, logicFile="logic/weather/cosmic_tornado_near_player.logic", weight = 1 },
		...
		{ action = "spawn_comet_boss_random_ta", type = "NEGATIVE", gameStates = "IDLE|STREAMING", minEventLevel = 4, logicFile="logic/event/comet_boss_random_ta.logic"  },
		{ action = "spawn_comet_boss_random_ta", type = "NEGATIVE", gameStates = "IDLE|NO_STREAMING", minEventLevel = 4, logicFile="logic/event/comet_boss_random_ta.logic"  },
	...
	{			
		{ level = 1, minLevel = 6, prepareTime = 120, entryLogic = "logic/dom/major_attack_1_entry.logic", exitLogic = "logic/dom/major_attack_1_exit.logic" },
	}
