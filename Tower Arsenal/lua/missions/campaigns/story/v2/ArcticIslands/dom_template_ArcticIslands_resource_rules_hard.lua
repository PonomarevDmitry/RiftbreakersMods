return function()
    local rules = require("lua/missions/campaigns/story/v2/ArcticIslands/dom_template_ArcticIslands_resource_rules_default.lua")()
	...
	{			
		{ level = 3, minLevel = 4, prepareTime = 300, entryLogic = "logic/dom/major_attack_1_entry.logic", exitLogic = "logic/dom/major_attack_1_exit.logic" },     
	}
	
	rules.objectivesLogic = 
	{
		{ name = "logic/objectives/kill_elite_random_bosses.logic", minDifficultyLevel = 3 },
		...
		{ name = "logic/objectives/destroy_nest_cosmic_lesigian_multiple", minDifficultyLevel = 6 },
		...
		{ name = "logic/objectives/destroy_nest_cosmic_gnerot_multiple.logic", minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_cosmic_baxmoth_multiple.logic", minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_cosmic_phirian_multiple", minDifficultyLevel = 6 },
	}
