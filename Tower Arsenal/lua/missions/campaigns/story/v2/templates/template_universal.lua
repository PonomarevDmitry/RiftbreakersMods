...
function template_universal:Prepare()
	...
	{
		the_abys = "cosmonite_ore_vein",
		ArcticIslands = "cosmonite_ore_vein",
		acid = "palladium_vein",
		caverns = "cobalt_vein",
	...
	{
		the_abys = "spawners/loot_container_small_metallic",
		ArcticIslands = "spawners/loot_container_small_bulb",
	...
	{
		the_abys = { "open", "dense", "lakes" },
		ArcticIslands = { "open", "dense", "lakes" },
...
function template_universal:PrepareMissionGeneratorParams( params )	
	...
	if params.mission_type == "exploration" then
		...
		params:SetResourceAmount("cosmic_vent", RandInt( 0, 10 ) )
		...
		params:SetResourceAmount(rareResource, 10 )
		params:SetResourceAmount("cosmic_vent", RandInt( 3, 10 ) )
...
function template_universal:PrepareMapGenerator(params)
	...
	elseif self.mission_params.biome_name == "swamp" and self.mission_params.terrain_type == "liquid" then
		MapGenerator:SetNavigationCullingEnabled( false )
	elseif self.mission_params.biome_name == "ArcticIslands" and self.mission_params.terrain_type == "liquid" then
		MapGenerator:SetNavigationCullingEnabled( false )
	elseif self.mission_params.biome_name == "the_abys" and self.mission_params.terrain_type == "liquid" then
		MapGenerator:SetNavigationCullingEnabled( false )
	end
end
...
function template_universal:PrepareMissionTilesPool()
	...
	LogService:Log("MissionResources cosmic_vent = ".. tostring(self.mission_params:GetResourceAmount("cosmic_vent") ) )
	...
	--ARCTICISLANDS	
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_cosmic_creeper_pit/ArcticIslands_encounter_cosmic_creeper_pit.tile" ) -- REQUIREMENT: None
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_cultivator/ArcticIslands_encounter_cultivator.tile" ) -- REQUIREMENT: None
	
	if campaignData:GetStringOrDefault( "global.uranium_outpost_complete", "" ) == "true" then -- REQUIREMENT: Finished Uranium Outpost
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_hostile_hive/ArcticIslands_encounter_hostile_hive.tile" )	
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_cosmic_arachnoid_pit/ArcticIslands_encounter_cosmic_arachnoid_pit.tile" )	
	end	
	if campaignData:GetStringOrDefault( "global.titanium_outpost_complete", "" ) == "true" then -- REQUIREMENT: Finished Titanium Outpost
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_hostile_nest_2/ArcticIslands_encounter_hostile_nest_2.tile" )	
	end	
	if campaignData:GetStringOrDefault( "global.palladium_outpost_complete", "" ) == "true" then -- REQUIREMENT: Finished Palladium Outpost
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_hostile_nest/ArcticIslands_encounter_hostile_nest.tile" )	
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_hostile_nest_1/ArcticIslands_encounter_hostile_nest_1.tile" )	
	end	
	if campaignData:GetStringOrDefault( "global.metallic_outpost_stage_3_complete", "" ) == "true" then -- REQUIREMENT: Finished Metallic Outpost
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/arctic_encounter_factory/arctic_encounter_factory.tile" )	
	end		
	if campaignData:GetStringOrDefault( "global.swamp_outpost_stage_3_complete", "" ) == "true" then -- REQUIREMENT: Finished Swamp Outpost Stage 3
	table.insert( encounterTilePool.ArcticIslands, 1, "biomes/ArcticIslands/tiles/ArcticIslands_encounter_stronghold_01/ArcticIslands_encounter_stronghold_01.tile" )	
	end		
	...
	local missionGeneratorTilePool = 
	{
		["the_abys"] = 
		{
			...
			{	
				{
					tile_name = "biomes/the_abys/tiles/the_abys_plains_01/the_abys_plains_01.tile",
					
					min_instances = 1,
					random_weight =	6
				},	
				{
					tile_name = "biomes/the_abys/tiles/the_abys_plains_02/the_abys_plains_02.tile",
					
					min_instances = 1,
					random_weight =	6	
				},	
				{
					tile_name = "biomes/the_abys/tiles/the_abys_plains_03/the_abys_plains_03.tile",
					
					min_instances = 1,
					random_weight =	6	
				},	
				{
					tile_name = "biomes/the_abys/tiles/the_abys_plains_2x2_01/the_abys_plains_2x2_01.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_plains_2x2_02/the_abys_plains_2x2_02.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_lakes_01/the_abys_lakes_01.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_canyons_01/the_abys_canyons_01.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_canyons_02/the_abys_canyons_02.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_canyons_03/the_abys_canyons_03.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_cliffs_01/the_abys_cliffs_01.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_cliffs_02/the_abys_cliffs_02.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_cliffs_03/the_abys_cliffs_03.tile",
				...
				{
					tile_name = "biomes/the_abys/tiles/the_abys_cliffs_04/the_abys_cliffs_04.tile",
		...
		["ArcticIslands"] = 
		{
			...
			{	
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_01/ArcticIslands_01.tile",
					min_instances = 0,
					max_instances = 0,
					random_weight =	0	
				},		
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_1/ArcticIslands_1.tile",
					min_instances = 0,
					max_instances = 0,
					random_weight =	0	
				},		
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_2/ArcticIslands_2.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},	
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_3/ArcticIslands_3.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_4/ArcticIslands_4.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_5/ArcticIslands_5.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_01/ArcticIslands_plains_01.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},		
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_02/ArcticIslands_plains_02.tile",
					min_instances = 1,
					max_instances = 4,
					random_weight =	1	
				},		
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_03/ArcticIslands_plains_03.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},	
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_04/ArcticIslands_plains_04.tile",
					min_instances = 2,
					--max_instances = 4,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_05/ArcticIslands_plains_05.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_06/ArcticIslands_plains_06.tile",
					min_instances = 1,
					max_instances = 2,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_07/ArcticIslands_plains_07.tile",
					min_instances = 2,
					--max_instances = 4,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_plains_08/ArcticIslands_plains_08.tile",
					min_instances = 2,
					--max_instances = 4,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_canyons_01/ArcticIslands_canyons_01.tile",
					min_instances = 1,
					max_instances = 1,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_canyons_02/ArcticIslands_canyons_02.tile",
					min_instances = 1,
					max_instances = 1,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_canyons_03/ArcticIslands_canyons_03.tile",
					min_instances = 1,
					max_instances = 1,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_cliffs_01/ArcticIslands_cliffs_01.tile",
					min_instances = 1,
					max_instances = 1,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_cliffs_02/ArcticIslands_cliffs_02.tile",
					min_instances = 1,
					max_instances = 1,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_cliffs_03/ArcticIslands_cliffs_03.tile",
					min_instances = 1,
					max_instances = 1,
					random_weight =	1	
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_01/ArcticIslands_lakes_01.tile",
					max_instances = 0,
					random_weight =	0			
				},	
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_02/ArcticIslands_lakes_02.tile",
					max_instances = 0,
					random_weight =	0			
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_03/ArcticIslands_lakes_03.tile",
					max_instances = 0,
					random_weight =	0			
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_04/ArcticIslands_lakes_04.tile",
					max_instances = 0,
					random_weight =	0			
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_05/ArcticIslands_lakes_05.tile",
					max_instances = 0,
					random_weight =	0			
				},
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_06/ArcticIslands_lakes_06.tile",
					max_instances = 0,
					random_weight =	0			
				},	
				{
					tile_name = "biomes/ArcticIslands/tiles/ArcticIslands_lakes_07/ArcticIslands_lakes_07.tile",
					max_instances = 0,
					random_weight =	0			
				},
			},
...
-- CREATURES
	...
	local biome_creatures =
	{
		...
		{        
			...
			{
				{
					creature_species = "cosmic_crawlog",
					volume_spawn_ratio = 2
				},
				{
					creature_species = "cosmic_gulgor",
					volume_spawn_ratio = 1.5
				},
				{
					creature_species = "cosmic_stregaros_crystal",
					volume_spawn_ratio = 2
				},
				{
	...
	--GUEST UNITS
	-- Add Drexolians after completing Heart of the Swamp DLC
	if self.mission_params.biome_name == "ArcticIslands" then
		if campaignData:GetStringOrDefault( "global.swamp_end", "" ) == "true" then -- REQUIREMENT: Finished Heart of the Swamp DLC
			table.insert( biome_creatures[self.mission_params.biome_name].liquid_units, 1, { creature_species = "cosmic_lesigian", volume_spawn_ratio = 1 } )
		end	
	end
...
-- MISSION OBJECT SPAWNERS
	...
	local abyss_magneticRocks =
	{
		spawner_type                    = "MarkerBlueprintSpawner",
		spawn_pool                      = { "abyss_magnetic_rocks" },
		spawn_at_marker                 = "logic/spawn_special_object",
		...
		{
			{
				spawn_blueprint         = "props/special/magnetic_rocks/abyss_magnetic_big_01",
				spawn_chance            = 0.15
			},
			{                    
				spawn_blueprint         = "props/special/magnetic_rocks/abyss_magnetic_medium_01",
				spawn_chance            = 0.1
			},
			{                    
				spawn_blueprint         = "props/special/magnetic_rocks/abyss_magnetic_small_01",
				spawn_chance            = 0.1
			}
		}
    }
	
	local the_abys_spawners =
	{
		spawner_type                    = "MarkerBlueprintSpawner",
		...
		{
            player_spawn_point          = 70.0,			
            bioanomaly_cluster          = 50.0,			
            biocache_cluster            = 250.0,		
            loot_containers             = 65.0,			
            loot_containers_small       = 50.0,			
            resource_volumes            = 10.0,			
            power_well                  = 30.0,			
            the_abys_spawners           = 50.0,			
			underground_treasure_cluster_primary = 150	
		},                                    

		spawn_instances_minmax          = { min = 20, max = 30 },

		spawn_blueprints =
		{
			{
				spawn_blueprint         = "spawners/the_abys_spawner_standard",
				spawn_chance            = 0.5
			},
			{                    
				spawn_blueprint         = "spawners/the_abys_spawner_advanced",
				spawn_instances_minmax          = { min = 3, max = 5 },
				spawn_chance            = 0.2
			},
			{                    
				spawn_blueprint         = "spawners/the_abys_spawner_superior",
				spawn_instances_minmax          = { min = 2, max = 3 },
				spawn_chance            = 0.2
			},
			{                    
				spawn_blueprint         = "spawners/the_abys_spawner_extreme",
				spawn_instances_minmax          = { min = 1, max = 2 },
				spawn_chance            = 0.1
			},
		}
    }
	-- random alien tower randomly around the map
	local the_abys_alien_tower_randomizer = 
	{
		spawner_type                    = "GridSpawner",
		spawn_pool                      = { "alien_tower_randomizer", "enemy" },		
		spawn_team               		= "enemy",
		...
		{
			{
				spawn_blueprint         = "units/ground/random_alien_tower",	
				spawn_instances_minmax          = { min = 10, max = 10 },
				spawn_chance			= 0.25,	
	...
	-- cosmic artigians randomly around the map
	local the_abys_cosmic_artigian = 
	{
		spawner_type                    = "GridSpawner",
		...
		{
			{
				spawn_blueprint         = "units/ground/cosmic_artigian",	
				spawn_instances_minmax          = { min = 10, max = 10 },
				spawn_chance			= 0.25,
				spawn_culls_entities_around	= false
			},
	...
	local spawners =
	{
		...
		spawn_min_distance_from_pools   = 
		{
            ...
            loot_containers             = 65.0,			
            loot_containers_small       = 50.0,			
            cosmic_yeast_root           = 30.0,			
            cosmic_yeast_singular       = 30.0,			
            resource_volumes            = 10.0,			
            power_well                  = 30.0,			
            spawners                    = 50.0,			
			underground_treasure_cluster_primary = 150	
		...
		{
			{
				spawn_blueprint         = "spawners/cosmic_spawner_standard",
				spawn_chance            = 0.5
			},
			{                    
				spawn_blueprint         = "spawners/cosmic_spawner_advanced",
				spawn_instances_minmax          = { min = 7, max = 9 },
				spawn_chance            = 0.5
			},
			{                    
				spawn_blueprint         = "spawners/cosmic_spawner_superior",
				spawn_instances_minmax          = { min = 5, max = 7 },
				spawn_chance            = 0.5
			},
			{                    
				spawn_blueprint         = "spawners/cosmic_spawner_extreme",
				spawn_instances_minmax          = { min = 3, max = 5 },
				spawn_chance            = 0.5
			},
		}
    }
	local cryogenic_yeast_colony_large = 
    {
		spawner_type                    = "MarkerBlueprintSpawner",
		spawn_pool                      = { "cryogenic_yeast_root" },
		spawn_at_marker                 = "logic/spawn_objective",        
		spawn_team               		= "enemy",
		...
		{
			player_spawn_point          = 250,	
			cosmic_yeast_root           = 200,	
			loot_containers             = 50,	
            loot_containers_small       = 40.0,	
			resource_volumes   	        = 20,	
            biocache_cluster            = 60,	
            spawners                    = 50	
		},										
		...
		{
			{
				spawn_blueprint         = "units/ground/cryogenic_crystal_creeper_root_origin"				
			},
		}
    }
	
	local cosmic_yeast_colony_large = 
    {
		spawner_type                    = "MarkerBlueprintSpawner",
		spawn_pool                      = { "cosmic_yeast_root" },
		spawn_at_marker                 = "logic/spawn_objective",        
		spawn_team               		= "enemy",
		...
		{
			{
				spawn_blueprint         = "units/ground/cosmic_yeast_root_origin_base"				
			},
		}
    }
	
	local cosmic_yeast_colony_small = 
	{
		spawner_type                    = "GridSpawner",
		spawn_pool                      = { "cosmic_yeast_singular" },		
		spawn_team               		= "enemy",
		spawn_min_free_cell_margin		= 2,
		
		spawn_instances_minmax          = { min = 15, max = 30 },
		
		spawn_min_distance_from_pools   = 
		{
			player_spawn_point              = 100,	
			mission_objective	            = 70,	
			cryogenic_yeast_root            = 150,	
			cosmic_yeast_root		        = 150,	
			cosmic_yeast_singular	        = 50,	
			loot_containers                 = 70,	
			loot_containers_small           = 30,	
			underground_treasures	        = 70,	
			cosmic_underground_mushrooms    = 70,	
			power_well				        = 40,	
			resource_volumes   	            = 5,	
            biocache_cluster                = 30,	
            spawners                        = 50	
		...
		{
			{
				spawn_blueprint         = "units/ground/cosmic_yeast_root_acid_singular"				
			},
		}		
	}
	
	local cosmic_underground_mushrooms =
	{
		spawner_type                    = "GridSpawner",
		spawn_pool                      = { "cosmic_underground_mushrooms" },		
		spawn_team               		= "enemy",
		spawn_min_free_cell_margin		= 2,
		...
		spawn_min_distance_from_pools   = 
		{
			...
			loot_containers_small         = 30,
			underground_treasures         = 70,
			cosmic_underground_mushrooms  = 180,
			power_well                    = 30,
			resource_volumes              = 5	
		},	
		spawn_blueprints =
		{
			{
				spawn_blueprint         = "props/special/undergound_mushroom/cosmic_mushroom_hidden",				
				spawn_group_radius			= 40,
				spawn_group_count			= 10,
				spawn_group_object_distance	= 8	
			},
		}	
	}
	
	-- random alien tower randomly around the map
	local alien_tower_randomizer = 
	{
		spawner_type                    = "GridSpawner",
		spawn_pool                      = { "alien_tower_randomizer", "enemy" },		
		spawn_team               		= "enemy",
	...
	elseif self.mission_params.biome_name == "the_abys" then
		table.insert(mission_object_spawners, 3, cryoPlants )
		table.insert(mission_object_spawners, 4, abyss_magneticRocks )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, the_abys_artigian )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, the_abys_alien_tower_randomizer )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, the_abys_spawners )	
	...
	elseif self.mission_params.biome_name == "ArcticIslands" then
		table.insert(mission_object_spawners, 3, cryogenic_yeast_colony_large )
		table.insert(mission_object_spawners, 3, cosmic_yeast_colony_large )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, cosmic_yeast_colony_small )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, cosmic_underground_mushrooms )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, cosmic_artigian )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, alien_tower_randomizer )
		table.insert(mission_object_spawners, #mission_object_spawners + 1, spawners )	
	elseif self.mission_params.biome_name == "caverns" then
	...
	if self.luckyEncounter == "bioanomaly" then
		table.insert(mission_object_spawners, 4, bioanomalyClusterPrimary )
		table.insert(mission_object_spawners, 6, bioanomalyClusterSecondary )
		table.insert(mission_object_spawners, 8, biocacheCluster )
	elseif self.luckyEncounter == "biocache" then		
		table.insert(mission_object_spawners, 4, biocacheClusterPrimary )		
		table.insert(mission_object_spawners, 6, biocacheCluster )
	elseif self.luckyEncounter == "underground_treasure" then
		table.insert(mission_object_spawners, 4, undergroundTreasureClusterPrimary )		
		table.insert(mission_object_spawners, 6, undergroundTreasureCluster )		
	end
	...
	local biome_resources =
	{
		...
		["ArcticIslands"] =
		{
			regular_large_resources =
			{
				...
				ResourceVolume( "iron_vein", 10, 15, 16000, 32000, nil ),
				ResourceVolume( advanceResourceName, 15, 20, 12000, 24000, nil ),
				ResourceVolume( "geothermal_vent", 1, 2, nil, nil, { is_infinite = true } ),
				ResourceVolume( "cosmic_vent", 1, 4, nil, nil, { is_infinite = true }  )		
			},			
			regular_small_resources =
			{
			...
			underground_resources =
			{
				...
				ResourceVolume( advanceResourceName, 3, 5, 12000, 24000, { required_discovery_lvl = 1 } ),
				ResourceVolume( "geothermal_vent", 2, 4, nil, nil, { required_discovery_lvl = 1, is_infinite = true } ),
				ResourceVolume( "cosmic_vent", 2, 4, nil, nil, { required_discovery_lvl = 1, is_infinite = true })
			},			
			liquid_resources =
			{
				ResourceVolume( "water_vein", 4, 8, nil, nil, { is_infinite = true } ),				
			},
			starting_resources = 
			{
				ResourceVolume( "carbon_vein", 2, 2, 60000, 70000, nil ),
				ResourceVolume( "iron_vein", 2, 2, 24000, 40000, nil ),
				ResourceVolume( advanceResourceName, 1, 2, 16000, 28000, nil )        
			}	
		},	
