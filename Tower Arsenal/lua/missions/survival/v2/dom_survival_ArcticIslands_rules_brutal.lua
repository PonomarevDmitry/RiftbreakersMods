return function()
	...
	rules.objectivesLogic = 
	{
		...
		{ name = "logic/objectives/destroy_cosmic_yeast.logic",                   minDifficultyLevel = 2 },
		{ name = "logic/objectives/destroy_cryogenic_yeast.logic",                minDifficultyLevel = 2 },
		{ name = "logic/objectives/destroy_nest_cosmic_canoptrix_single.logic",   minDifficultyLevel = 2 },
		{ name = "logic/objectives/destroy_nest_cosmic_canoptrix_multiple.logic", minDifficultyLevel = 2 },
		--{ name = "logic/objectives/destroy_nest_cosmic_morirot_single.logic",     minDifficultyLevel = 2 },
		--{ name = "logic/objectives/destroy_nest_cosmic_morirot_multiple.logic",   minDifficultyLevel = 4 },
		{ name = "logic/objectives/destroy_nest_arctic_boss.logic",               minDifficultyLevel = 4 },
	}
