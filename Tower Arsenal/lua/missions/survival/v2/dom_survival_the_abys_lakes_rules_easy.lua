return function()
    local rules = require("lua/missions/survival/v2/dom_survival_the_abys_rules_lakes_default.lua")()
	...
	rules.objectivesLogic = 
	{
		...
		{ name = "logic/objectives/destroy_nest_cosmic_canoptrix_single.logic", minDifficultyLevel = 2, maxDifficultyLevel = 9 }, 
		--{ name = "logic/objectives/destroy_nest_cosmic_canoptrix_multiple.logic", minDifficultyLevel = 2 },
		{ name = "logic/objectives/destroy_nest_cosmic_morirot_single.logic", minDifficultyLevel = 2, maxDifficultyLevel = 9 }, 
