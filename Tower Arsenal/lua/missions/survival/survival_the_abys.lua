...
class 'survival_the_abys' ( survival_base )

function survival_the_abys:__init()
    survival_base.__init(self,self)
end

function survival_the_abys:init()
	survival_base.init( self )
	LogService:Log( "survival_the_abys:init()" )
    ...
    local rulesPath = GetRulesForDifficulty( "lua/missions/survival/v2/dom_survival_the_abys_rules_" )

	MissionService:AddGameRule( "lua/missions/v2/dom_manager.lua", rulesPath )
end

return survival_the_abys
