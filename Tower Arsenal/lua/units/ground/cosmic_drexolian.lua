...
class 'cosmic_drexolian' ( base_unit )

function cosmic_drexolian:__init()
	base_unit.__init(self, self)
end

function cosmic_drexolian:OnInit()
	...
	self.waller = self.data:GetStringOrDefault( "waller", "misc/waller_cosmic" )
...
function cosmic_drexolian:OnUniformExecute( state, dt )
...
function cosmic_drexolian:OnSleepEvent( evt )
	self.newUniformValue = evt:GetEmissiveValue()
end

function cosmic_drexolian:OnShootArtilleryEvent( evt )
...
function cosmic_drexolian:OnShootEvent( evt )
