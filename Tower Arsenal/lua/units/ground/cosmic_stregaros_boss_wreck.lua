...
class 'cosmic_stregaros_boss_wreck' ( wreck_ground_unit )

function cosmic_stregaros_boss_wreck:__init()
	wreck_ground_unit.__init(self, self)
end

function cosmic_stregaros_boss_wreck:initParams()
...
function cosmic_stregaros_boss_wreck:OnEnterResurrect( state )
...
function cosmic_stregaros_boss_wreck:OnExitResurrect( state )
...
function cosmic_stregaros_boss_wreck:_OnDestroyRequest( state )
    EntityService:RequestDestroyPattern( self.entity, "resurrect" )
end

function cosmic_stregaros_boss_wreck:_OnAnimationStateChanged( evt )
...
return cosmic_stregaros_boss_wreck