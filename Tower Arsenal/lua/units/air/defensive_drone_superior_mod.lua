...
class 'defensive_drone_superior_mod' ( base_drone )

function defensive_drone_superior_mod:__init()
	base_drone.__init(self,self)
end

function defensive_drone_superior_mod:FindActionTarget()
    return INVALID_ID
end

function defensive_drone_superior_mod:FillInitialParams()
    ...
    self.lightning_effect = self.data:GetStringOrDefault("lightning_effect", "effects/buildings_and_machines/drone_defensive_superior_mod_lightning");
...
function defensive_drone_superior_mod:ShootLightningAtTarget(target_entity)
    self:SetEmissiveUniform( 0.0 )
...
function defensive_drone_superior_mod:SetEmissiveUniform( factor )
...
function defensive_drone_superior_mod:OnFinderExecute(state)
...
function defensive_drone_superior_mod:OnInit()
    self:FillInitialParams();
end

function defensive_drone_superior_mod:OnLoad()
    self:FillInitialParams();
    
    base_drone.OnLoad( self )
end

return defensive_drone_superior_mod;