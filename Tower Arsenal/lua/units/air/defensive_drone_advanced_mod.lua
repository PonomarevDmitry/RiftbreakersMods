...
class 'defensive_drone_advanced_mod' ( base_drone )

function defensive_drone_advanced_mod:__init()
	base_drone.__init(self,self)
end

function defensive_drone_advanced_mod:FindActionTarget()
    return INVALID_ID
end

function defensive_drone_advanced_mod:FillInitialParams()
    ...
    self.search_interval = self.data:GetFloatOrDefault("search_interval", 0.2);

    self.lightning_effect = self.data:GetStringOrDefault("lightning_effect", "effects/buildings_and_machines/drone_defensive_advanced_mod_lightning");
    self.lightning_hit_effect = self.data:GetStringOrDefault("lightning_effect", "effects/buildings_and_machines/drone_defensive_mod_lightning_hit");
...
function defensive_drone_advanced_mod:ShootLightningAtTarget(target_entity)
    self:SetEmissiveUniform( 0.0 )
...
function defensive_drone_advanced_mod:SetEmissiveUniform( factor )
...
function defensive_drone_advanced_mod:OnFinderExecute(state)
...
function defensive_drone_advanced_mod:OnInit()
    self:FillInitialParams();
end

function defensive_drone_advanced_mod:OnLoad()
    self:FillInitialParams();
    
    base_drone.OnLoad( self )
end

return defensive_drone_advanced_mod;