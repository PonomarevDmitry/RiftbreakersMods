...
class 'ta_base_skill' ( LuaEntityObject )

function ta_base_skill:__init()
	LuaEntityObject.__init(self, self)
end

function ta_base_skill:init()
...
function ta_base_skill:SetupScale( scale )
	local parent = EntityService:GetParent( self.entity )
...
function ta_base_skill:_OnEnteredTriggerEvent( evt )
    ...
    --LogService:Log( "ta_base_skill:_OnEnteredTriggerEvent : " .. tostring( EntityService:GetBlueprintName( entity ) ) )
end

function ta_base_skill:_OnLeftTriggerEvent( evt )
    local entity = evt:GetOtherEntity()
