local base_skill = require("lua/units/skills/ta_base_skill.lua")
class 'hedroner_time_dmg' ( base_skill )

function hedroner_time_dmg:__init()
	base_skill.__init(self, self)
end

function hedroner_time_dmg:OnInit()
	...
	displayRadiusComponent.min_radius = radius / 0.1 -- min_radius scale hack
	...
	worldEffectComponentHelper.max_health_percentage_damage_threshold = 1
