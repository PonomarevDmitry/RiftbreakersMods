...
function cosmic_cultivator:OnInit()
...
function cosmic_cultivator:OnLoad()
...
function cosmic_cultivator:RegisterBuildMenuTracker()
...
function cosmic_cultivator:CreateProductionStateMachine()
...
function cosmic_cultivator:CreateMenuEntity()
...
function cosmic_cultivator:OnRelease()
...
function cosmic_cultivator:GetDefaultSaplingItem()
...
function cosmic_cultivator:OnBuildingStart()
...
function cosmic_cultivator:OnBuildingEnd()
...
function cosmic_cultivator:_OnBuildingModifiedEvent()
...
function cosmic_cultivator:OnActivate()
...
function cosmic_cultivator:PopulateSpecialActionInfo()
...
function cosmic_cultivator:RefreshDrones()
...
function cosmic_cultivator:DroneSpawned(drone)
...
function cosmic_cultivator:OnLuaGlobalEvent( evt )
...
function cosmic_cultivator:DisableVegetationAround()
...
function cosmic_cultivator:OnItemEquippedEvent( evt )
...
function cosmic_cultivator:GetPlayerForEntity( entity )
...
function cosmic_cultivator:AddSaplingToLastList(selectedBlueprintName, selectorDB)
...
function cosmic_cultivator:GetCurrentList(parameterName, selectorDB)
...
function cosmic_cultivator:GetCurrentListString(parameterName, selectorDB)
...
function cosmic_cultivator:DestoryPlanIcon()
...
function cosmic_cultivator:OnLuaGlobalEventCultivatorShowHideIcon()
    -- Legacy Empty function
end

function cosmic_cultivator:OnEnterBuildMenuEvent( evt )
...
function cosmic_cultivator:OnEnterFighterModeEvent( evt )
...
function cosmic_cultivator:SetCultivatorSaplingMenuVisible()
...
function cosmic_cultivator:OnUpdateProductionExecute()
...
function cosmic_cultivator:AddResourceToProductionGroup( resourceName, rowNumber )
...
function cosmic_cultivator:IsResourceInGatherable( resourceName, resourceList )
...
function cosmic_cultivator:OnBuildingStartEventGettingInfo(evt)
...
function cosmic_cultivator:GettingInfoFromRuin()
...
function cosmic_cultivator:OnBuildingRemovedEventTrasferingInfoToRuin(evt)
