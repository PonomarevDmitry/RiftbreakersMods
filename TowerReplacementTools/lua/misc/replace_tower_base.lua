...
class 'replace_tower_base' ( tool )

function replace_tower_base:__init()
    tool.__init(self,self)
end

function replace_tower_base:InitBlueprintList(selectedBlueprintName, selectedBlueprints, cacheBlueprintsLowNames)
...
function replace_tower_base:GetFirstLevelBuilding(blueprintName)
...
function replace_tower_base:FillCache(cacheBlueprints, selectedBlueprints)
...
function replace_tower_base:FillSelectedBlueprintsList( list, blueprintName, seenBlueprintList )
...
function replace_tower_base:IsBlueprintInList( selectedBlueprints, cacheBlueprints, blueprintName )
...
function replace_tower_base:CalcIsBlueprintInList( selectedBlueprints, blueprintName )
...
function replace_tower_base:GetMenuIcon( blueprintName )
...
function replace_tower_base:GetBuildingMenuIcon( blueprintName )
...
function replace_tower_base:SetEntitySelectedMaterial( entity, material )
